...
The installation process of the \ac{HiP} backend is quite simple. In general, you need to install 3 different things: The Play 2.0 framework, the MongoDB and \ac{NPM}. 
...
\endlastfoot
	...
	UW36 & Topic edit: Exchange fullscreen logo  & Yes & 3 \\
	...
	UW46 & Topic edit: Add \emph{delete mode} for tags to prevent deleting & Yes & 2 \\
	& by accident   &  &  \\
