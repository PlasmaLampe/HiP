...
Figure \ref{workflow_backend} shows the workflow within the backend system as a flow diagram.

\begin{figure}[th]
\centerline{\includegraphics[width=1.3\textwidth]{gfx/HiP-Backend-Workflow}}
\caption{The diagram shows the workflow within the backend system with the three roles that are involved in the workflow}
