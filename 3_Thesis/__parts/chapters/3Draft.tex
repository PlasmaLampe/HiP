...
These four different roles are also shown in Figure \ref{usecase} an \ac{UML2} use case diagram, which is placed in the appendix. The figure shows the roles together with the functionality that gets invoked by these roles. 	
