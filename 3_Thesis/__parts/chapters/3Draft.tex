...
The following pseudo-code in Listing \ref{locked} shows the algorithm that is used to lock the topics. \todo{describe}
...
\begin{lstlisting}[numbers=left,caption={},label=locked,frame=tlbr,breaklines]
onChange(){
