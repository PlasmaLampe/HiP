...
An easy way to create a navigation feature would be the usage of the google directions service \cite{GoogleNavi}. However, this runs not natively on Android.
