...
In the following we want to outline the two most important directives that have been created for the client side. Both directives consists of three different parts that need to be combined to create the actual directive:
...
In  % show picture instead of HTML and both others
