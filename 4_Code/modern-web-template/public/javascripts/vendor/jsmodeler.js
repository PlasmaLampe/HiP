/* JSModeler 0.35 - http://www.github.com/kovacsv/JSModeler */
'use strict';
var JSM = function() {
    this.mainVersion = 0;
    this.subVersion = 35
...
JSM.AsyncEnvironment = function(a) {
    this.parameters = a
};
JSM.AsyncEnvironment.prototype.OnStart = function(a, b) {
    if (void 0 !== this.parameters && void 0 !== this.parameters.onStart)
        this.parameters.onStart(a, b)
};
JSM.AsyncEnvironment.prototype.OnProcess = function(a, b) {
    if (void 0 !== this.parameters && void 0 !== this.parameters.onProcess)
        this.parameters.onProcess(a, b)
};
JSM.AsyncEnvironment.prototype.OnFinish = function(a) {
    if (void 0 !== this.parameters && void 0 !== this.parameters.onFinish)
        this.parameters.onFinish(a)
};
JSM.AsyncRunTask = function(a, b, c, d, e) {
    function f(g) {
        var h = a();
        b.OnProcess(g, e);
        h && g < c - 1 ? setTimeout(function() {
            f(g + 1)
...
JSM.PolarCoord = function(a, b) {
    this.radius = a;
    this.angle = b
};
JSM.PolarCoord.prototype.Set = function(a, b) {
    this.radius = a;
    this.angle = b
};
...
JSM.SphericalCoord = function(a, b, c) {
    this.radius = a;
    this.theta = b;
    this.phi = c
};
JSM.SphericalCoord.prototype.Set = function(a, b, c) {
    this.radius = a;
    this.theta = b;
    this.phi = c
};
...
JSM.MatrixDeterminant4x4 = function(a, b, c, d, e, f, g, h, k, l, m, n, p, q, t, r) {
    var v = JSM.MatrixDeterminant3x3(f, g, h, l, m, n, q, t, r), u = JSM.MatrixDeterminant3x3(e, g, h, k, m, n, p, t, r);
    h = JSM.MatrixDeterminant3x3(e, f, h, k, l, n, p, q, r);
    e = JSM.MatrixDeterminant3x3(e, f, g, k, l, m, p, q, t);
...
JSM.CoordIsEqual2DWithEps = function(a, b, c) {
    return JSM.IsEqualWithEps(a.x, b.x, c) && JSM.IsEqualWithEps(a.y, b.y, c)
};
JSM.CoordDistance2D = function(a, b) {
    var c = a.x, d = a.y, e = b.x, f = b.y;
    return Math.sqrt((e - c) * (e - c) + (f - d) * (f - d))
};
...
JSM.CoordTurnType2D = function(a, b, c) {
    a = JSM.MatrixDeterminant3x3(a.x, a.y, 1, b.x, b.y, 1, c.x, c.y, 1);
    return JSM.IsPositive(a) ? "CounterClockwise" : JSM.IsNegative(a) ? "Clockwise" : "Collinear"
};
JSM.CoordIsEqual = function(a, b) {
    return JSM.IsEqual(a.x, b.x) && JSM.IsEqual(a.y, b.y) && JSM.IsEqual(a.z, b.z)
};
JSM.CoordIsEqualWithEps = function(a, b, c) {
    return JSM.IsEqualWithEps(a.x, b.x, c) && JSM.IsEqualWithEps(a.y, b.y, c) && JSM.IsEqualWithEps(a.z, b.z, c)
};
...
JSM.CoordDistance = function(a, b) {
    ...
    return Math.sqrt((f - c) * (f - c) + (g - d) * (g - d) + (h - e) * (h - e))
};
JSM.CoordSignedDistance = function(a, b, c) {
    var d = JSM.CoordSub(b, a);
    a = JSM.CoordDistance(a, b);
    c = JSM.GetVectorsAngle(d, c);
...
JSM.VectorMultiply = function(a, b) {
...
JSM.VectorLength = function(a) {
    var b = a.x, c = a.y;
    a = a.z;
    return Math.sqrt(b * b + c * c + a * a)
};
JSM.VectorNormalize = function(a) {
    var b = JSM.VectorLength(a), c = new JSM.Vector(0, 0, 0);
    JSM.IsGreater(b, 0) && (c = JSM.VectorMultiply(a, 1 / b));
    return c
};
JSM.VectorSetLength = function(a, b) {
    var c = b / JSM.VectorLength(a);
    return JSM.VectorMultiply(a, c)
};
JSM.GetVectorsAngle = function(a, b) {
    var c = JSM.VectorNormalize(a), d = JSM.VectorNormalize(b);
    if (JSM.CoordIsEqual(c, d))
        return 0;
    c = JSM.VectorDot(c, d);
    return JSM.ArcCos(c)
};
JSM.GetVectorsFullAngle = function(a, b, c) {
    var d = JSM.GetVectorsAngle(a, b), e = new JSM.Coord(0, 0, 0);
    "Clockwise" == JSM.CoordTurnType(a, e, b, c) && (d = 2 * Math.PI - d);
    return d
};
JSM.VectorsAreCollinear = function(a, b) {
    var c = JSM.GetVectorsAngle(a, b);
    return JSM.IsEqual(c, 0) || JSM.IsEqual(c, Math.PI)
};
...
JSM.CoordOffset = function(a, b, c) {
    b = JSM.VectorNormalize(b);
...
JSM.CoordRotate = function(a, b, c, d) {
    var e = JSM.CoordSub(a, d), f = JSM.VectorNormalize(b);
    b = f.x;
    a = f.y;
    var f = f.z, g = e.x, h = e.y, e = e.z, k = Math.sin(c);
    c = Math.cos(c);
    var l = new JSM.Coord(0, 0, 0);
    l.x =- b * ( - b * g - a * h - f * e) * (1 - c) + g * c + ( - f * h + a * e) * k;
    l.y =- a * ( - b * g - a * h - f * e) * (1 - c) + h * c + (f * g - b * e) * k;
    l.z =- f * ( - b * g - a * h - f * e) * (1 - c) + e * c + ( - a * g + b * h) * k;
    return l = JSM.CoordAdd(l, d)
};
JSM.GetCoord2DFromCoord = function(a, b, c) {
    var d = new JSM.Vector(0, 0, 1), e = JSM.VectorCross(c, d);
    c = JSM.GetVectorsAngle(c, d);
    a = JSM.CoordRotate(a, e, c, b);
    return new JSM.Coord2D(a.x, a.y)
};
JSM.CoordTurnType = function(a, b, c, d) {
    var e = new JSM.Coord(0, 0, 0);
    a = JSM.GetCoord2DFromCoord(a, e, d);
    b = JSM.GetCoord2DFromCoord(b, e, d);
    c = JSM.GetCoord2DFromCoord(c, e, d);
    c = JSM.CoordTurnType2D(a, b, c);
    e = new JSM.Vector(0, 0, 1);
    d = JSM.GetVectorsAngle(d, e);
    JSM.IsEqual(d, Math.PI) && ("CounterClockwise" === c ? c = "Clockwise" : "Clockwise" === c && (c = "CounterClockwise"));
    return c
};
JSM.CalculateCentroid = function(a) {
    var b = a.length, c = new JSM.Coord(0, 0, 0);
    if (1 <= b) {
        var d;
        for (d = 0; d < b; d++)
            c = JSM.CoordAdd(c, a[d]);
        c = JSM.VectorMultiply(c, 1 / b)
    }
    return c
};
JSM.CalculateTriangleNormal = function(a, b, c) {
    ...
    c.y = b.z * a.x - b.x * a.z;
    c.z = b.x * a.y - b.y * a.x;
    return JSM.VectorNormalize(c)
};
JSM.CalculateNormal = function(a) {
    var b = a.length, c = new JSM.Vector(0, 0, 0);
    if (3 <= b) {
        var d, e, f;
        for (d = 0; d < b; d++)
            e = d%b, f = (d + 1)%b, e = a[e], f = a[f], c.x += (e.y - f.y) * (e.z + f.z), c.y += (e.z - f.z) * (e.x + f.x), c.z += (e.x - f.x) * (e.y + f.y)
    }
    return JSM.VectorNormalize(c)
};
...
JSM.CartesianToSpherical = function(a, b, c) {
    var d = new JSM.SphericalCoord(0, 0, 0);
    d.radius = Math.sqrt(a * a + b * b + c * c);
    if (JSM.IsZero(d.radius))
        return d;
    d.theta = Math.acos(c / d.radius);
    d.phi = Math.atan2(b, a);
    return d
};
JSM.SphericalToCartesianWithOrigo = function(a, b) {
    var c = JSM.SphericalToCartesian(a.radius, a.theta, a.phi);
    return JSM.CoordAdd(c, b)
};
JSM.CartesianToSphericalWithOrigo = function(a, b) {
    var c = JSM.CoordSub(a, b);
    return JSM.CartesianToSpherical(c.x, c.y, c.z)
};
JSM.MoveCoordOnSphere = function(a, b, c, d) {
    a = JSM.CartesianToSphericalWithOrigo(a, b);
    a.theta += c;
    a.phi += d;
    return JSM.SphericalToCartesianWithOrigo(a, b)
};
...
JSM.GetArcLength = function(a, b, c) {
    return JSM.GetVectorsAngle(a, b) * c
};
...
JSM.MatrixVectorMultiply = function(a, b) {
    var c = b[0], d = b[1], e = b[2], f = b[3], g = a[1], h = a[2], k = a[3], l = a[5], m = a[6], n = a[7], p = a[9], q = a[10], t = a[11], r = a[13], v = a[14], u = a[15], s = [];
    s[0] = c * a[0] + d * a[4] + e * a[8] + f * a[12];
    s[1] = c * g + d * l + e * p + f * r;
    s[2] = c * h + d * m + e * q + f * v;
    s[3] = c * k + d * n + e * t + f * u;
    return s
...
JSM.MatrixMultiply = function(a, b) {
    var c = a[0], d = a[1], e = a[2], f = a[3], g = a[4], h = a[5], k = a[6], l = a[7], m = a[8], n = a[9], p = a[10], q = a[11], t = a[12], r = a[13], v = a[14], u = a[15], s = b[0], x = b[1], z = b[2], y = b[3], w = b[4], A = b[5], B = b[6], L = b[7], N = b[8], F = b[9], C = b[10], D = b[11], J = b[12], O = b[13], M = b[14], H = b[15], G = [];
    G[0] = c * s + d * w + e * N + f * J;
    G[1] = c * x + d * A + e * F + f * O;
    G[2] = c * z + d * B + e * C + f * M;
    G[3] = c * y + d * L + e * D + f * H;
    ...
    G[10] = m * z + n * B +
    p * C + q * M;
    G[11] = m * y + n * L + p * D + q * H;
    G[12] = t * s + r * w + v * N + u * J;
    G[13] = t * x + r * A + v * F + u * O;
    G[14] = t * z + r * B + v * C + u * M;
    G[15] = t * y + r * L + v * D + u * H;
    return G
};
JSM.MatrixDeterminant = function(a) {
    var b = a[0], c = a[1], d = a[2], e = a[3], f = a[4], g = a[5], h = a[6], k = a[7], l = a[8], m = a[9], n = a[10], p = a[11], q = a[12], t = a[13], r = a[14];
    a = a[15];
    return (b * g - c * f) * (n * a - p * r) - (b * h - d * f) * (m * a - p * t) + (b * k - e * f) * (m * r - n * t) + (c * h - d * g) * (l * a - p * q) - (c * k - e * g) * (l * r - n * q) + (d * k - e * h) * (l * t - m * q)
};
JSM.MatrixInvert = function(a) {
    var b = a[0], c = a[1], d = a[2], e = a[3], f = a[4], g = a[5], h = a[6], k = a[7], l = a[8], m = a[9], n = a[10], p = a[11], q = a[12], t = a[13], r = a[14];
    a = a[15];
    var v = b * g - c * f, u = b * h - d * f, s = b * k - e * f, x = c * h - d * g, z = c * k - e * g, y = d * k - e * h, w = l * t - m * q, A = l * r - n * q, B = l * a - p * q, L = m * r - n * t, N = m * a - p * t, F = n * a - p * r, C = v * F - u * N + s * L + x * B - z * A + y * w;
    if (JSM.IsZero(C))
        return null;
    var D = [];
    D[0] = (g * F - h * N + k * L) / C;
...
JSM.MatrixRotation = function(a, b, c) {
    var d = JSM.VectorNormalize(a);
    a = d.x;
    var e = d.y, d = d.z, f = a * a, g = e * e, h = d * d, k = Math.sin(b);
    b = Math.cos(b);
    var l = [];
    if (void 0 === c || null === c)
        l[0] = f + (g + h) * b, l[1] = a * e * (1 - b) + d * k, l[2] = a * d * (1 - b) - e * k, l[3] = 0, l[4] = a * e * (1 - b) - d * k, l[5] = g + (f + h) * b, l[6] = e * d * (1 - b) + a * k, l[7] = 0, l[8] = a * d * (1 - b) + e * k, l[9] = e * d * (1 - b) - a * k, l[10] = h + (f + g) * b, l[11] = 0, l[12] = 0, l[13] = 0, l[14] = 0;
    else {
        var m = c.x, n = c.y;
        c = c.z;
        l[0] = f + (g + h) * b;
...
JSM.MatrixRotationQuaternion = function(a) {
    var b = a[0], c = a[1], d = a[2], e = a[3], f = b + b, g = c + c, h = d + d;
    a = b * f;
    var k = b * g, b = b * h, l = c * g, c = c * h, d = d * h, f = e * f, g = e * g, e = e * h, h = [];
    h[0] = 1 - (l + d);
    h[1] = k + e;
    h[2] = b - g;
    h[3] = 0;
...
JSM.MatrixView = function(a, b, c) {
    if (JSM.CoordIsEqual(a, b))
        return JSM.MatrixIdentity();
    var d = [];
    b = JSM.VectorNormalize(JSM.CoordSub(a, b));
    c = JSM.VectorNormalize(JSM.VectorCross(c, b));
    var e = JSM.VectorNormalize(JSM.VectorCross(b, c));
    d[0] = c.x;
    d[1] = e.x;
    d[2] = b.x;
    d[3] = 0;
...
JSM.CoordSystemToDirectionVectors = function(a) {
    return new JSM.CoordSystem(a.origo, JSM.CoordSub(a.e1, a.origo), JSM.CoordSub(a.e2, a.origo), JSM.CoordSub(a.e3, a.origo))
};
JSM.CoordSystemToAbsoluteCoords = function(a) {
    return new JSM.CoordSystem(a.origo, JSM.CoordAdd(a.e1, a.origo), JSM.CoordAdd(a.e2, a.origo), JSM.CoordAdd(a.e3, a.origo))
};
...
JSM.CoordSectorPosition2D = function(a, b) {
    var c = a.x, d = a.y, e = b.beg.x, f = b.beg.y, g = b.end.x, h = b.end.y, k = b.GetLength();
    if (JSM.IsZero(k))
        return JSM.CoordIsEqual2D(a, b.beg) ? "CoordOnSectorEndCoord" : "CoordOutsideOfSector";
    k = ((c - e) * (g - e) + (d - f) * (h - f)) / (k * k);
    if (JSM.IsLower(k, 0) || JSM.IsGreater(k, 1))
        return "CoordOutsideOfSector";
    f += k * (h - f);
    return !JSM.IsEqual(e + k * (g - e), c) ||!JSM.IsEqual(f, d) ? "CoordOutsideOfSector" : JSM.IsEqual(k, 0) || JSM.IsEqual(k, 1) ? "CoordOnSectorEndCoord" : "CoordInsideOfSector"
};
JSM.CoordSectorPosition = function(a, b) {
    var c = a.x, d = a.y, e = a.z, f = b.beg, g = JSM.CoordSub(b.end, b.beg), h = f.x, k = f.y, l = f.z, m = f.x + g.x, n = f.y + g.y, p = f.z + g.z, q = (m - h) * (m - h) + (n - k) * (n - k) + (p - l) * (p - l);
    if (JSM.IsZero(q))
        return JSM.CoordIsEqual(f, a) ? "CoordOnSectorEndCoord" : "CoordOutsideOfSector";
    c = ((m - h) * (c - h) + (n - k) * (d - k) + (p - l) * (e - l)) / q;
    f = JSM.CoordAdd(f, JSM.VectorMultiply(g, c));
    f = JSM.CoordDistance(a, f);
    return JSM.IsZero(f) ? JSM.IsLower(c, 0) || JSM.IsGreater(c, 1) ? "CoordOutsideOfSector" : JSM.IsEqual(c, 0) || JSM.IsEqual(c, 1) ? "CoordOnSectorEndCoord" :
    "CoordInsideOfSector" : "CoordOutsideOfSector"
};
JSM.SectorSectorPosition2D = function(a, b, c) {
    var d = a.beg.x, e = a.beg.y, f = a.end.x, g = a.end.y, h = b.beg.x, k = b.beg.y, l = b.end.x, m = b.end.y, n = (l - h) * (e - k) - (m - k) * (d - h), p = (f - d) * (e - k) - (g - e) * (d - h);
    if (JSM.IsZero(n) && JSM.IsZero(p))
        return c = JSM.CoordSectorPosition2D(a.beg, b), d = JSM.CoordSectorPosition2D(a.end, b), e = JSM.CoordSectorPosition2D(b.beg, a), a = JSM.CoordSectorPosition2D(b.end, a), "CoordInsideOfSector" === c || ("CoordInsideOfSector" === d || "CoordInsideOfSector" === e || "CoordInsideOfSector" === a) || "CoordOnSectorEndCoord" ===
        c && "CoordOnSectorEndCoord" === d && "CoordOnSectorEndCoord" === e && "CoordOnSectorEndCoord" === a ? "SectorsIntersectsCoincident" : "CoordOnSectorEndCoord" === c || "CoordOnSectorEndCoord" === d || "CoordOnSectorEndCoord" === e || "CoordOnSectorEndCoord" === a ? "SectorsIntersectsEndPoint" : "SectorsDontIntersects";
    a = (m - k) * (f - d) - (l - h) * (g - e);
    if (JSM.IsZero(a))
        return "SectorsDontIntersects";
    n/=a;
    p/=a;
    if (JSM.IsLower(n, 0) || JSM.IsGreater(n, 1) || JSM.IsLower(p, 0) || JSM.IsGreater(p, 1))
        return "SectorsDontIntersects";
    void 0 !== c && (c.x = d + n * (f -
    d), c.y = e + n * (g - e));
    return JSM.IsEqual(n, 0) || JSM.IsEqual(n, 1) || JSM.IsEqual(p, 0) || JSM.IsEqual(p, 1) ? "SectorsIntersectsEndPoint" : "SectorsIntersectsOnePoint"
};
JSM.GetSectorSegmentation = function(a, b, c) {
    var d = JSM.CoordSub(a.end, a.beg), e = JSM.CoordDistance(a.beg, a.end) / b, f = 0, g;
    for (g = 0; g <= b; g++)
        c.push(JSM.CoordOffset(a.beg, d, f)), f += e
};
...
JSM.CoordLinePosition2D = function(a, b) {
    var c = b.start, d = b.direction, c = d.x * (a.y - c.y) - d.y * (a.x - c.x);
    return JSM.IsPositive(c) ? "CoordAtLineLeft" : JSM.IsNegative(c) ? "CoordAtLineRight" : "CoordOnLine"
};
JSM.CoordLinePosition = function(a, b, c) {
    var d = a.x, e = a.y, f = a.z, g = b.start;
    b = b.direction;
    var h = g.x, k = g.y, l = g.z, m = g.x + b.x, n = g.y + b.y, p = g.z + b.z, q = (m - h) * (m - h) + (n - k) * (n - k) + (p - l) * (p - l);
    if (JSM.IsZero(q))
        return void 0 !== c && c.Set(g.x, g.y, g.z), JSM.CoordIsEqual(g, a) ? "CoordOnLine" : "CoordOutsideOfLine";
    d = JSM.CoordAdd(g, JSM.VectorMultiply(b, ((m - h) * (d - h) + (n - k) * (e - k) + (p - l) * (f - l)) / q));
    void 0 !== c && c.Set(d.x, d.y, d.z);
    a = JSM.CoordDistance(a, d);
    return JSM.IsZero(a) ? "CoordOnLine" : "CoordOutsideOfLine"
};
JSM.ProjectCoordToLine = function(a, b) {
    var c = new JSM.Coord(0, 0, 0), d = a.x, e = a.y, f = a.z, g = b.start, h = b.direction, k = g.x, l = g.y, m = g.z, n = g.x + h.x, p = g.y + h.y, q = g.z + h.z, t = (n - k) * (n - k) + (p - l) * (p - l) + (q - m) * (q - m);
    if (JSM.IsZero(t))
        return c.Set(g.x, g.y, g.z), c;
    d = JSM.CoordAdd(g, JSM.VectorMultiply(h, ((n - k) * (d - k) + (p - l) * (e - l) + (q - m) * (f - m)) / t));
    c.Set(d.x, d.y, d.z);
    return c
};
JSM.LineLineClosestPoint = function(a, b, c, d) {
    ...
    var f = JSM.VectorNormalize(a.direction), g = a.start, f = JSM.CoordAdd(g, f);
    a = JSM.VectorNormalize(b.direction);
    b = b.start;
    var h = JSM.CoordAdd(b, a), k = [g, f, b, h], l = e(k, 1, 0, 1, 0), m = e(k, 0, 2, 1, 0), h = e(k, 0, 2, 3, 2), n = e(k, 3, 2, 1, 0), k = e(k, 3, 2, 3, 2), l = l * k - n * n;
    if (JSM.IsEqual(l, 0))
        return !1;
    m = (h * n - m * k) / l;
    h = (h + m * n) / k;
    void 0 !== c && (f = JSM.VectorNormalize(JSM.CoordSub(f,
    g)), g = JSM.CoordAdd(g, JSM.VectorMultiply(f, m)), c.Set(g.x, g.y, g.z));
    void 0 !== d && (c = JSM.CoordAdd(b, JSM.VectorMultiply(a, h)), d.Set(c.x, c.y, c.z));
    return !0
};
JSM.LineLinePosition = function(a, b, c) {
    var d = new JSM.Coord(0, 0, 0), e = new JSM.Coord(0, 0, 0);
    return !JSM.LineLineClosestPoint(a, b, d, e) ? "LinesIntersectsCoincident" : JSM.CoordIsEqual(d, e) ? (void 0 !== c && c.Set(d.x, d.y, d.z), "LinesIntersectsOnePoint") : "LinesDontIntersects"
};
...
JSM.BoxUnion = function(a, b) {
    var c = new JSM.Coord(JSM.Minimum(a.min.x, b.min.x), JSM.Minimum(a.min.y, b.min.y), JSM.Minimum(a.min.z, b.min.z)), d = new JSM.Coord(JSM.Maximum(a.max.x, b.max.x), JSM.Maximum(a.max.y, b.max.y), JSM.Maximum(a.max.z, b.max.z));
...
JSM.OffsetTransformation = function(a, b) {
    var c = JSM.VectorNormalize(a), c = JSM.VectorMultiply(c, b);
...
JSM.GetPlaneFromCoordAndDirection = function(a, b) {
    var c = new JSM.Plane, d = JSM.VectorNormalize(b), e = d.x, f = d.y, d = d.z;
    c.Set(e, f, d, - (e * a.x + f * a.y + d * a.z));
    return c
};
JSM.GetPlaneFromThreeCoords = function(a, b, c) {
    var d = new JSM.Plane, e = (b.y - a.y) * (c.z - a.z) - (c.y - a.y) * (b.z - a.z), f = (b.z - a.z) * (c.x - a.x) - (c.z - a.z) * (b.x - a.x);
    b = (b.x - a.x) * (c.y - a.y) - (c.x - a.x) * (b.y - a.y);
    d.Set(e, f, b, - (e * a.x + f * a.y + b * a.z));
    return d
};
JSM.CoordPlanePosition = function(a, b) {
    var c = b.a * a.x + b.b * a.y + b.c * a.z + b.d;
    return JSM.IsPositive(c) ? "CoordInFrontOfPlane" : JSM.IsNegative(c) ? "CoordAtBackOfPlane" : "CoordOnPlane"
};
JSM.LinePlanePosition = function(a, b, c) {
    var d = JSM.VectorNormalize(a.direction), e = a.start.x, f = a.start.y, g = a.start.z, h = b.a, k = b.b, l = b.c;
    b = b.d;
    var m = h * (e - (a.start.x + d.x)) + k * (f - (a.start.y + d.y)) + l * (g - (a.start.z + d.z));
    if (JSM.IsZero(m))
        return "LineParallelToPlane";
    void 0 !== c && (a = JSM.CoordAdd(a.start, JSM.VectorMultiply(d, (h * e + k * f + l * g + b) / m)), c.Set(a.x, a.y, a.z));
    return "LineIntersectsPlane"
};
JSM.LinePlaneIntersection = function(a, b) {
    var c = JSM.VectorNormalize(a.direction), d = a.start.x, e = a.start.y, f = a.start.z, g = a.start.x + c.x, h = a.start.y + c.y, k = a.start.z + c.z, l = b.a, m = b.b, n = b.c, p = b.d, q = new JSM.Coord(0, 0, 0), g = l * (d - g) + m * (e - h) + n * (f - k);
    return JSM.IsZero(g) ? q : q = JSM.CoordAdd(a.start, JSM.VectorMultiply(c, (l * d + m * e + n * f + p) / g))
};
JSM.CoordPlaneSignedDistance = function(a, b) {
    var c = b.a, d = b.b, e = b.c;
    return (c * a.x + d * a.y + e * a.z + b.d) / Math.sqrt(c * c + d * d + e * e)
};
JSM.CoordPlaneDistance = function(a, b) {
    return Math.abs(JSM.CoordPlaneSignedDistance(a, b))
};
JSM.CoordPlaneSignedDirectionalDistance = function(a, b, c) {
    var d = JSM.VectorNormalize(b);
    b = a.x;
    var e = a.y, f = a.z, g = c.a, h = c.b, k = c.c;
    c = c.d;
    var l = g * (b - (a.x + d.x)) + h * (e - (a.y + d.y)) + k * (f - (a.z + d.z));
    if (JSM.IsZero(l))
        return 0;
    d = JSM.CoordAdd(a, JSM.VectorMultiply(d, (g * b + h * e + k * f + c) / l));
    a = JSM.CoordDistance(a, d);
...
JSM.ProjectCoordToPlane = function(a, b) {
    var c = a.x, d = a.y, e = a.z, f = b.a, g = b.b, h = b.c, k = b.d, l = JSM.CoordPlaneDistance(a, b);
    JSM.IsGreater(f * c + g * d + h * e + k, 0) && (l =- l);
    c = JSM.VectorNormalize(new JSM.Coord(f, g, h));
    return JSM.CoordOffset(a, c, l)
};
JSM.Project = function(a, b, c, d, e, f, g, h, k) {
    b = JSM.MatrixView(b, c, d);
    g = JSM.MatrixPerspective(e, f, g, h);
    ...
    h[2] = a.z;
    h[3] = 1;
    f = JSM.MatrixVectorMultiply(g, JSM.MatrixVectorMultiply(b, h));
    a = f[3];
    JSM.IsZero(a) ? k = null : (f[0] = 0.5 * (f[0] / a) + 0.5, f[1] = 0.5 * (f[1] / a) + 0.5, f[2] = 0.5 * (f[2] / a) + 0.5, f[0] = f[0] * k[2] + k[0], f[1] = f[1] * k[3] + k[1], e.x = f[0], e.y = f[1], e.z = f[2], k = e);
    return k
};
JSM.ConvexHull2D = function(a) {
    function b(a, b) {
        ...
        for (e = 1; e < c; e++)
            b == d ? d = e : "Clockwise" == JSM.CoordTurnType2D(a[b], a[d], a[e]) && (d = e);
        return d
    }
    var c = [];
    if (3 > a.length)
    ...
    var d = function(a) {
        ...
        for (e = 0; e < b; e++)
            f = a[e].x, JSM.IsLower(f, c) && (c = f, d = e);
        return d
    }(a), e = d, f;
    do 
        c.push(e), e = f = b(a, e);
...
JSM.ConvexHull3D = function(a) {
    ...
    function g(a, b, c, e) {
        var g = a.triangles.length, h = f(a, g, b, c), k = f(a, g, c, e), g = f(a, g, e, b), l = new d;
        l.vertices = [b, c, e];
        l.edges = [h, k, g];
        l.valid=!0;
        a.triangles.push(l);
    ...
    function l(a, b) {
        ...
        for (d = 0; d < a.triangles.length; d++)
            e = a.triangles[d], e.valid?!JSM.IsLower(k(a, e.vertices[0], e.vertices[2], e.vertices[1], b), 0) ? c.push(!0) : c.push(!1) : c.push(!1);
        var f, l, m, n = [];
        for (d = 0; d < c.length; d++)
            c[d] && (e = a.triangles[d], e.valid && (f = a.edges[e.edges[0]], l = a.edges[e.edges[1]], m = a.edges[e.edges[2]], f =- 1 == f.tri1||-1 == f.tri2 || c[f.tri1] != c[f.tri2], l =- 1 == l.tri1||-1 == l.tri2 || c[l.tri1] != c[l.tri2], m =- 1 == m.tri1||-1 == m.tri2 || c[m.tri1] !=
            c[m.tri2], f && n.push([e.vertices[0], e.vertices[1], b]), l && n.push([e.vertices[1], e.vertices[2], b]), m && n.push([e.vertices[2], e.vertices[0], b])));
        for (d = 0; d < c.length; d++)
            c[d] && (e = a.triangles[d], e.valid && (e = a, m = d, f = e.triangles[m], f.valid && (h(e, m, f.edges[0]), h(e, m, f.edges[1]), h(e, m, f.edges[2]), f.valid=!1)));
        for (d = 0; d < n.length; d++)
            c = n[d], g(a, c[0], c[1], c[2])
    }
    var m = [], n = a.length;
    if (4 > n)
        return m;
    ...
    (function(a) {
        var b =
        - 1, b=!JSM.IsLower(k(a, 0, 1, 2, 3), 0) ? g(a, 0, 1, 2) : g(a, 0, 2, 1), b = a.triangles[b];
    ...
    for (q = 4; q < n; q++)
        l(p, q);
    for (q = 0; q < p.triangles.length; q++)
        a = p.triangles[q], a.valid && m.push(a.vertices);
    return m
};
...
JSM.Polygon2D.prototype.AddVertex = function(a, b) {
    this.vertices.push(new JSM.Coord2D(a, b))
};
JSM.Polygon2D.prototype.GetVertex = function(a) {
    return this.vertices[a]
};
JSM.Polygon2D.prototype.SetVertex = function(a, b, c) {
    this.vertices[a].Set(b, c)
};
...
JSM.ContourPolygon2D.prototype.AddVertex = function(a, b, c) {
    void 0 === this.polygons[a] && (this.polygons[a] = new JSM.Polygon2D);
    this.polygons[a].AddVertex(b, c)
};
JSM.ContourPolygon2D.prototype.VertexCount = function(a) {
    return void 0 === this.polygons[a] ? 0 : this.polygons[a].VertexCount()
};
JSM.ContourPolygon2D.prototype.GetVertex = function(a, b) {
    return this.polygons[a].GetVertex(b)
};
JSM.ContourPolygon2D.prototype.SetVertex = function(a, b, c, d) {
...
JSM.ContourPolygon2D.prototype.Clone = function() {
    var a = new JSM.ContourPolygon2D, b;
    for (b = 0; b < this.polygons.length; b++)
        a.polygons.push(this.polygons[b].Clone());
    return a
};
...
JSM.Polygon.prototype.SetVertex = function(a, b, c, d) {
...
JSM.Polygon.prototype.Clone = function() {
    var a = new JSM.Polygon, b;
    for (b = 0; b < this.vertices.length; b++)
        a.vertices.push(this.vertices[b].Clone());
    return a
};
JSM.CreatePolygonFromVertices = function(a) {
    var b = new JSM.Polygon2D, c, d;
    for (c = 0; c < a.length; c++)
        d = a[c], b.AddVertex(d.x, d.y);
    return b
};
JSM.PolygonSignedArea2D = function(a) {
    var b = a.VertexCount(), c = 0, d, e, f;
    for (d = 0; d < b; d++)
        e = a.GetVertex(d), f = a.GetVertex((d + 1)%b), c += e.x * f.y - f.x * e.y;
    return c / 2
};
JSM.PolygonArea2D = function(a) {
    return Math.abs(JSM.PolygonSignedArea2D(a))
};
JSM.PolygonOrientation2D = function(a) {
    a = JSM.PolygonSignedArea2D(a);
    return JSM.IsPositive(a) ? "CounterClockwise" : JSM.IsNegative(a) ? "Clockwise" : "Invalid"
};
JSM.ChangePolygonOrientation2D = function(a) {
    var b = a.Clone();
    a.Clear();
    var c, d;
    for (c = b.VertexCount() - 1; 0 <= c; c--)
        d = b.GetVertex(c), a.AddVertex(d.x, d.y)
};
JSM.CreateCCWPolygonFromVertices = function(a) {
    a = JSM.CreatePolygonFromVertices(a);
    "CounterClockwise" != JSM.PolygonOrientation2D(a) && JSM.ChangePolygonOrientation2D(a);
    return a
};
JSM.PolygonComplexity2D = function(a) {
    var b=!1, c=!1, d = a.VertexCount(), e, f, g, h;
    for (e = 0; e < d; e++)
        if (f = 0 === e ? d - 1 : e - 1, g = e, h = e === d - 1 ? 0 : e + 1, f = a.GetVertex(f), g = a.GetVertex(g), h = a.GetVertex(h), h = JSM.CoordTurnType2D(f, g, h), "CounterClockwise" === h ? b=!0 : "Clockwise" === h && (c=!0), b && c)
            return "Concave";
    return !b&&!c ? "Invalid" : "Convex"
};
JSM.CoordPolygonPosition2D = function(a, b) {
    var c = b.VertexCount(), d, e, f;
    for (d = 0; d < c; d++)
        if (e = b.GetVertex(d), f = b.GetVertex((d + 1)%c), e = new JSM.Sector2D(e, f), "CoordOutsideOfSector" !== JSM.CoordSectorPosition2D(a, e))
            return "CoordOnPolygonEdge";
    var g = 0, h;
    for (d = 0; d < c; d++)
        h = Math.abs(b.GetVertex(d).x - a.x), JSM.IsGreater(h, g) && (g = h);
    g = new JSM.Sector2D(a, new JSM.Coord2D(a.x + 2 * g, a.y));
    h = 0;
    var k;
    for (d = 0; d < c; d++)
        e = b.GetVertex(d), f = b.GetVertex((d + 1)%c), e = new JSM.Sector2D(e, f), f = new JSM.Coord2D(0, 0), k = JSM.SectorSectorPosition2D(g,
        e, f), "SectorsDontIntersects" !== k && ("SectorsIntersectsOnePoint" === k ? h++ : "SectorsIntersectsEndPoint" === k && (JSM.CoordIsEqual2D(f, e.beg) ? JSM.IsGreater(e.beg.y, e.end.y) && h++ : JSM.CoordIsEqual2D(f, e.end) && JSM.IsLower(e.beg.y, e.end.y) && h++));
    return 0 === h%2 ? "CoordOutsideOfPolygon" : "CoordInsideOfPolygon"
};
JSM.SectorIntersectsPolygon2D = function(a, b, c, d) {
    var e = a.VertexCount(), f, g, h;
    for (f = 0; f < e; f++)
        if (g = f, h = (f + 1)%e, !(g == c || h == c || g == d || h == d))
            if (g = new JSM.Sector2D(a.GetVertex(g), a.GetVertex(h)), g = JSM.SectorSectorPosition2D(b, g), "SectorsDontIntersects" !== g)
                return !0;
    return !1
};
JSM.IsPolygonVertexVisible2D = function(a, b, c) {
    if (b === c)
        return !1;
    var d = a.VertexCount();
    if (c === (0 < b ? b - 1 : d - 1) || c === (b < d - 1 ? b + 1 : 0))
        return !1;
    d = new JSM.Sector2D(a.GetVertex(b), a.GetVertex(c));
    if (JSM.SectorIntersectsPolygon2D(a, d, b, c))
        return !1;
    b = JSM.MidCoord2D(d.beg, d.end);
    return "CoordInsideOfPolygon" !== JSM.CoordPolygonPosition2D(b, a)?!1 : !0
};
JSM.CreatePolygonWithHole2D = function(a) {
    function b(a, b) {
        if (void 0 !== g[b])
            return !1;
        var e=!1, h = d[b] + 1, l = d[b + 1];
        if (0 === b) {
            for (; h < l; h++)
                c.push(h);
            g[b]=!0
        } else {
            for (var l = new JSM.Polygon2D, k, h = 0; h < c.length; h++)
                k = a[c[h]], l.AddVertex(k.x, k.y);
            for (var v = null, u = d[b] + 1, s = f[b], x, h = 0; h < l.VertexCount(); h++) {
                for (k = 0; k < s.VertexCount(); k++) {
                    x = new JSM.Sector(l.GetVertex(h), s.GetVertex(k));
                    b:
                    {
                        var z = k, y = s, w = f, A = g;
                        if (JSM.SectorIntersectsPolygon2D(l, x, h, - 1))
                            x=!1;
                        else if (JSM.SectorIntersectsPolygon2D(y, x, - 1, z))
                            x=!1;
                        else {
                            y =
                            z = void 0;
                            for (z = 0; z < w.length; z++)
                                if (!(z == b || void 0 !== A[z]))
                                    if (y = w[z], JSM.SectorIntersectsPolygon2D(y, x, - 1, - 1)) {
                                        x=!1;
                                        break b
                                    }
                            x=!0
            ...
            if (null === l)
                ...
                for (u = 0; u < v.length; u++)
                    if (w = v[u], c.push(w), w == l[0]) {
                        A = l[1];
                        s=!0;
                        for (x=!1; !x;)
                            c.push(A), !s && A == l[1] && (x=!0), s && (s=!1), A = A < k - 1 ? A + 1 : h;
                            c.push(w)
                    }
                l=!0
            }
    ...
    var f = function(a, b, c) {
        ...
        for (e = 0; e < b; e++) {
            f = c[e] + 1;
            g = c[e + 1];
            for (h = new JSM.Polygon2D; f < g; f++)
                l = a[f], h.AddVertex(l.x, l.y);
            d.push(h)
        }
        return d
    }(a, e, d), g = {}, h = 1;
...
JSM.PolygonTriangulate2D = function(a) {
    function b(a, b) {
        var c = [], d, e, g, h;
        for (d = 0; d < a.length; d++)
            if (g = a[d], 3 === g.length)
                if ("CounterClockwise" === b)
                    c.push(g);
                else {
                    h = [];
    ...
    function c(a, b, c) {
        if (b === c)
            return !1;
        var d = a.VertexCount(), e;
        if (!(e = (b < d - 1 ? b + 1 : 0) === c))
            e = (0 < b ? b - 1 : d - 1) === c;
        return e?!1 : JSM.IsPolygonVertexVisible2D(a, b, c)
    }
    function d(a, b, c, d) {
        var e = a.length;
        if (3 >= e)
        ...
        for (f = 0; 2 > f; f++) {
            h = g =- 1;
            0 === f ? (g = b, h = c) : 1 === f && (g = c, h = b);
            l =
            [];
            for (l.push(a[h]); g !== h; g = g < e - 1 ? g + 1 : 0)
                l.push(a[g]);
            d.push(l)
        }
        return !0
    }
    var e = a.Clone(), f = e.VertexCount();
    if (3 > f)
        return [];
    a = [];
    var g = [], h, k, l;
    ...
    if (3 === f)
        return a;
    k = JSM.PolygonComplexity2D(e);
    g = JSM.PolygonOrientation2D(e);
    if ("Invalid" === k || "Invalid" === g)
        return [];
    if ("CounterClockwise" !== g) {
        var m, n, p;
        for (h = 0; h < f / 2; h++)
            m = h, n = f - h - 1, p = e.vertices[m], e.vertices[m] = e.vertices[n], e.vertices[n] = p
    }
    if ("Convex" === k) {
        for (h = 0; h < f - 2; h++)
            e = [], e.push(0), e.push((h + 1)%f), e.push((h + 2)%
            f), a.push(e);
        return b(a, g)
    }
    var q;
    for (h = 0; h < a.length; h++)
        if (m = a[h], n = m.length, 3 !== n) {
            p = new JSM.Polygon2D;
            for (k = 0; k < n; k++)
                l = e.GetVertex(m[k]), p.AddVertex(l.x, l.y);
                q=!1;
                for (k = 0; k < n; k++) {
                    for (l = 0; l < n; l++)
                        if (c(p, k, l)) {
...
JSM.CheckTriangulation2D = function(a, b) {
    var c = JSM.PolygonSignedArea2D(a), d = 0, e, f, g, h, k;
    for (e = 0; e < b.length; e++) {
        ...
        for (f = 0; f < g.length; f++)
            k = a.GetVertex(g[f]), h.AddVertex(k.x, k.y);
        d += JSM.PolygonSignedArea2D(h)
    }
    return !JSM.IsEqual(c, d)?!1 : !0
};
JSM.CreatePolygonWithHole = function(a) {
    var b = [], c;
    for (c = 0; c < a.length; c++)
        null !== a[c] && b.push(a[c]);
    var b = JSM.CalculateNormal(b), d = new JSM.Coord(0, 0, 0), e = [], f;
    for (c = 0; c < a.length; c++)
        null !== a[c] ? (f = JSM.GetCoord2DFromCoord(a[c], d, b), e.push(f)) : e.push(null);
    return JSM.CreatePolygonWithHole2D(e)
};
JSM.PolygonTriangulate = function(a) {
    var b = new JSM.Polygon2D, c = JSM.CalculateNormal(a.vertices), d = new JSM.Coord(0, 0, 0), e = a.VertexCount(), f, g;
    for (f = 0; f < e; f++)
        g = JSM.GetCoord2DFromCoord(a.GetVertex(f), d, c), b.AddVertex(g.x, g.y);
    return JSM.PolygonTriangulate2D(b)
};
JSM.OffsetPolygonContour = function(a, b) {
    var c = a.VertexCount(), d = JSM.CalculateNormal(a.vertices), e, f, g, h, k, l = new JSM.Polygon, m;
    for (m = 0; m < c; m++)
        e = 0 === m ? c - 1 : m - 1, f = m, g = m === c - 1 ? 0 : m + 1, e = a.GetVertex(e), f = a.GetVertex(f), h = a.GetVertex(g), k = JSM.CoordSub(e, f), g = JSM.CoordSub(h, f), k = JSM.GetVectorsAngle(k, g) / 2, "Clockwise" === JSM.CoordTurnType(e, f, h, d) && (k = Math.PI - k), e = b / Math.sin(k), e = JSM.CoordOffset(f, g, e), e = JSM.CoordRotate(e, d, k, f), l.AddVertex(e.x, e.y, e.z);
    return l
};
JSM.CutPolygonWithPlane = function(a, b, c, d, e) {
    function f(a, b, c, d, e) {
        1 == b ? c.push(a) : - 1 == b ? d.push(a) : e.push(a)
    }
    function g(a, b, c, d) {
        function e(a, b) {
            if (!(2 > b.length)) {
                for (var c = a.GetVertex(b[0]), d = a.GetVertex(b[1]), d = JSM.CoordSub(d, c), f = JSM.GetPlaneFromCoordAndDirection(c, d), g, d = [], c = 0; c < b.length; c++)
                    g = a.GetVertex(b[c]), d.push(JSM.CoordPlaneSignedDistance(g, f));
                for (c = 0; c < b.length - 1; c++)
                    for (f = 0; f < b.length - c - 1; f++)
                        if (JSM.IsGreater(d[f], d[f + 1])) {
                            g = d;
                            var h = f + 1, l = g[f];
                            g[f] = g[h];
                            g[h] = l;
        ...
        function f(a, b, c, d, e, g) {
            ...
            var k = 0;
            g && (k = b.length - 1);
            for (var m = b[k], n = m, p=!1, q = 0, r = new JSM.Polygon, t; ;) {
                p || (q = c[n], 0 !== q && (p=!0));
                if (0 < r.VertexCount() && n == m)
                    if (1 == q ? d.push(r) : - 1 == q && e.push(r), r = new JSM.Polygon, 0 < k && k < b.length) {
                        n = m = b[k];
                        continue
                    } else 
                        break;
                t = a.GetVertex(n);
                r.AddVertex(t.x, t.y, t.z);
                - 1 !=
                l[n] ? (k = g ? k - 2 : k + 2, n = l[n], h(l, n)) : n = n < a.VertexCount() - 1 ? n + 1 : 0
            }
        }
        var g = function(a) {
            var b = [], c, d, e, f;
            for (c = 0; c < a.length; c++)
                if (d = a[c], 0 === d) {
                    d = 0 < c ? c - 1 : a.length - 1;
                    e = c < a.length - 1 ? c + 1 : 0;
                    f = a[d];
                    e = a[e];
                    if (0 !== e && 0 === f) {
                        for (; 0 === a[d];)
                            d = 0 < d ? d - 1 : a.length - 1;
                            f = a[d]
                    }( - 1 == f && 1 == e || 1 == f&&-1 == e) && b.push(c)
                }
            return b
        }(b);
        0 === g.length || 0 !== g.length%2 || (e(a, g), f(a, g, b, c, d, !1), f(a, g, b, c, d, !0))
    }
    var h = new JSM.Polygon, k = [];
    b = function(a, b, c, d) {
        function e(a, c, d, f, g) {
            function h(a, c, d, e, f, g) {
                var k = d[d.length - 1];
                0 !== k && (0 !== g &&
                k != g) && (e = a.GetVertex(e), a = a.GetVertex(f), a = new JSM.Line(a, JSM.CoordSub(a, e)), f = new JSM.Coord(0, 0, 0), "LineIntersectsPlane" == JSM.LinePlanePosition(a, b, f) && (c.AddVertex(f.x, f.y, f.z), d.push(0)))
            }
            function k(a, b, c, d, e) {
                a = a.GetVertex(d);
                b.AddVertex(a.x, a.y, a.z);
                c.push(e)
            }
            var l = 0 === c, n = c === a.VertexCount(), p;
            n ? (c = 0, p = a.VertexCount() - 1) : p = c - 1;
            f = f[c];
            l || h(a, d, g, p, c, f);
            n || k(a, d, g, c, f);
            return f
        ...
        var f = [], g=!1, h=!1, k, s, x;
        for (k = 0; k < a.VertexCount(); k++)
            s = a.GetVertex(k), s = JSM.CoordPlanePosition(s, b), x = 0, "CoordInFrontOfPlane" ==
            s ? (x = 1, h=!0) : "CoordAtBackOfPlane" == s && (x =- 1, g=!0), f.push(x);
        if (g && h)
            for (k = 0; k <= a.VertexCount(); k++)
                e(a, k, c, f, d);
        else {
    ...
    0 === h.VertexCount() && 0 === k.length ? f(a, b, c, d, e) : g(h, k, c, d);
    return 0 === c.length + d.length + e.length?!1 : !0
};
JSM.Octree = function(a, b) {
    this.coords = [];
    this.root = {
        center: JSM.MidCoord(a.min, a.max),
        size: JSM.CoordSub(a.max, a.min),
        coords: [],
        children: null
    };
...
JSM.Octree.prototype.FindNode = function(a, b) {
    if (null === b.children)
        return b;
    var c = a.x > b.center.x, d = a.y > b.center.y, e = a.z > b.center.z;
    return !c&&!d&&!e ? this.FindNode(a, b.children[0]) : c&&!d&&!e ? this.FindNode(a, b.children[1]) : c && d&&!e ? this.FindNode(a, b.children[2]) : !c && d&&!e ? this.FindNode(a, b.children[3]) : !c&&!d && e ? this.FindNode(a, b.children[4]) : c&&!d && e ? this.FindNode(a, b.children[5]) : c && d && e ? this.FindNode(a, b.children[6]) : !c && d && e ? this.FindNode(a, b.children[7]) : null
};
JSM.Octree.prototype.SplitNode = function(a) {
    function b(a, b, c, d) {
        var k = a.center.Clone();
        a = JSM.VectorMultiply(a.size, 0.5);
        k.x += 0.5 * b * a.x;
        k.y += 0.5 * c * a.y;
        k.z += 0.5 * d * a.z;
        return {
    ...
    if (JSM.IsZero(a.size.x) && JSM.IsZero(a.size.y) && JSM.IsZero(a.size.z))
        return !1;
    a.children = [b(a, - 1, - 1, - 1), b(a, 1, - 1, - 1), b(a, 1, 1, - 1), b(a, - 1, 1, - 1), b(a, - 1, - 1, 1), b(a, 1, - 1, 1), b(a, 1, 1, 1), b(a, - 1, 1, 1)];
    var c = a.coords;
    a.coords = [];
    var d;
    for (d = 0; d < c.length; d++)
        this.FindNode(this.coords[c[d]], a).coords.push(c[d]);
    return !0
};
...
JSM.BSPTree.prototype.AddPolygon = function(a, b) {
    null === this.root && (this.root = this.GetNewNode());
...
JSM.BSPTree.prototype.AddPolygonToNode = function(a, b, c) {
    ...
    var d;
    if (null === a.polygon) {
        d = JSM.CalculateNormal(b.vertices);
        ...
        d = [];
        var f = [], e = [];
        JSM.CutPolygonWithPlane(b, a.plane, f, d, e) && (0 < d.length && this.AddInsidePolygonsToNode(a, d, c), 0 < f.length && this.AddOutsidePolygonsToNode(a, f, c), 0 < e.length && (d = JSM.CalculateNormal(b.vertices), 0 < JSM.VectorDot(d, a.plane.GetNormal()) ?
        this.AddInsidePolygonsToNode(a, e, c) : this.AddOutsidePolygonsToNode(a, e, c)))
    }
    return !0
};
JSM.BSPTree.prototype.AddInsidePolygonsToNode = function(a, b, c) {
    null === a.inside && (a.inside = this.GetNewNode(), a.inside.parent = a);
    var d;
    for (d = 0; d < b.length; d++)
        this.AddPolygonToNode(a.inside, b[d], c)
};
JSM.BSPTree.prototype.AddOutsidePolygonsToNode = function(a, b, c) {
    null === a.outside && (a.outside = this.GetNewNode(), a.outside.parent = a);
    var d;
    for (d = 0; d < b.length; d++)
...
JSM.ClipPolygonWithBSPTree = function(a, b, c, d, e, f) {
    function g(a, b, c) {
        if (null !== b) {
            var d = [], e = [], f = [];
            JSM.CutPolygonWithPlane(a, b.plane, e, d, f) && (0 < d.length && k(b, d, c), 0 < e.length && l(b, e, c), 0 < f.length && (a = JSM.CalculateNormal(a.vertices), 0 < JSM.VectorDot(a, b.plane.GetNormal()) ? k(b, f, !0) : l(b, f, !0)))
        }
    }
    function h(a, b) {
        var c;
...
JSM.TraverseBSPTreeForEyePosition = function(a, b, c) {
    function d(a) {
        if (null !== a) {
            var f = JSM.CoordPlanePosition(b, a.plane);
            "CoordInFrontOfPlane" == f ? (d(a.inside), c(a), d(a.outside)) : ("CoordAtBackOfPlane" == f ? (d(a.outside), c(a)) : d(a.outside), d(a.inside))
        }
    }
    d(a.root)
};
...
JSM.GenerateCirclePoints = function(a, b, c) {
    ...
    for (g = 0; g < b; g++)
        h = JSM.CylindricalToCartesian(a, 0, e), void 0 !== c && null !== c && (h = JSM.CoordAdd(h, c)), d.push(h), e += f;
    return d
};
JSM.GetRuledMesh = function(a, b, c, d, e) {
    if (a.length === b.length) {
        ...
        for (k = 0; k <= f; k++)
            g.push(JSM.CoordSub(b[k], a[k])), h.push(JSM.CoordDistance(a[k], b[k]));
        var l, m;
        for (k = 0; k <= f; k++) {
            l = h[k] / c;
            for (b = 0; b <= c; b++)
                m = JSM.CoordOffset(a[k], g[k], l * b), d.push(m)
            }
        for (k = 0; k < f; k++)
            for (b = 0; b < c; b++)
                a = k * (c + 1) + b, d = a + 1, g = a + c + 1, h = g + 1, a = [a, g, h, d], e.push(a)
    }
};
...
JSM.Body = function() {
    this.vertices = [];
    this.polygons = [];
    this.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1))
};
...
JSM.Body.prototype.SetTextureProjectionType = function(a) {
    this.projection = a
};
JSM.Body.prototype.GetTextureProjectionCoords = function() {
    return this.coords
};
JSM.Body.prototype.SetTextureProjectionCoords = function(a) {
    this.coords = a
};
JSM.Body.prototype.SetPlanarTextureProjection = function(a, b, c) {
    this.SetTextureProjectionType("Planar");
    this.SetTextureProjectionCoords(new JSM.CoordSystem(a, b, JSM.VectorCross(b, c), new JSM.Coord(0, 0, 0)))
};
JSM.Body.prototype.SetCubicTextureProjection = function(a, b, c, d) {
    this.SetTextureProjectionType("Cubic");
    this.SetTextureProjectionCoords(new JSM.CoordSystem(a, b, c, d))
};
JSM.Body.prototype.SetCylindricalTextureProjection = function(a, b, c, d) {
    this.SetTextureProjectionType("Cylindrical");
    this.SetTextureProjectionCoords(new JSM.CoordSystem(a, JSM.VectorSetLength(c, b), JSM.VectorSetLength(JSM.VectorCross(d, c), b), d))
};
JSM.Body.prototype.Transform = function(a) {
    var b;
    for (b = 0; b < this.vertices.length; b++)
        this.vertices[b].position = a.Apply(this.vertices[b].position);
    null !== this.coords && (b = JSM.CoordSystemToAbsoluteCoords(this.coords), b.origo = a.Apply(b.origo), b.e1 = a.Apply(b.e1), b.e2 = a.Apply(b.e2), b.e3 = a.Apply(b.e3), this.coords = JSM.CoordSystemToDirectionVectors(b))
};
JSM.Body.prototype.GetBoundingBox = function() {
    ...
    for (c = 0; c < this.vertices.length; c++)
        d = this.vertices[c].position, a.x = JSM.Minimum(a.x, d.x), a.y = JSM.Minimum(a.y, d.y), a.z = JSM.Minimum(a.z, d.z), b.x = JSM.Maximum(b.x, d.x), b.y = JSM.Maximum(b.y, d.y), b.z = JSM.Maximum(b.z, d.z);
...
JSM.Body.prototype.GetBoundingSphereRadius = function() {
    ...
    for (c = 0; c < this.vertices.length; c++)
        d = JSM.CoordDistance(a, this.vertices[c].position), JSM.IsGreater(d, b) && (b = d);
    return b
};
JSM.Body.prototype.OffsetToOrigo = function() {
    var a = this.GetCenter(), a = JSM.VectorMultiply(a, - 1), b;
    for (b = 0; b < this.vertices.length; b++)
...
JSM.Body.prototype.Clear = function() {
    this.vertices = [];
    this.polygons = [];
    this.coords = this.projection = null
};
JSM.Model = function() {
    this.bodies = []
};
...
JSM.HexColorToRGBComponents = function(a) {
    ...
    var c = parseInt(b.substr(2, 2), 16), b = parseInt(b.substr(4, 2), 16);
    return [a, c, b]
};
...
JSM.Light = function(a) {
    var b = {
        ambient: 8355711,
        diffuse: 8355711,
        specular: 0,
        direction: new JSM.Vector(1, 0, 0)
    };
    JSM.CopyObjectProperties(a, this, !0);
    JSM.CopyObjectProperties(b, this, !1)
};
JSM.Material = function(a) {
    JSM.CopyObjectProperties(a, this, !0);
    JSM.CopyObjectProperties({
        ambient: 52224,
        diffuse: 52224,
        specular: 0,
        shininess: 0,
...
JSM.Materials.prototype.GetMaterial = function(a) {
    return 0 > a || a >= this.materials.length ? this.defaultMaterial : this.materials[a]
};
JSM.Materials.prototype.AddMaterial = function(a) {
...
JSM.GetPolyEdgeStartVertex = function(a, b) {
    return a.reverse ? b.edges[a.index].vert2 : b.edges[a.index].vert1
};
JSM.GetPolyEdgeEndVertex = function(a, b) {
    return a.reverse ? b.edges[a.index].vert1 : b.edges[a.index].vert2
};
JSM.GetAnotherPgonOfEdge = function(a, b) {
...
JSM.CalculateAdjacencyInfo = function(a) {
    var b = new JSM.AdjacencyInfo, c, d, e;
    for (c = 0; c < a.VertexCount(); c++)
        d = new JSM.VertInfo, b.verts.push(d);
    var f, g, h, k, l;
    for (c = 0; c < a.PolygonCount(); c++) {
        f = a.GetPolygon(c);
        e = new JSM.PgonInfo;
        ...
        for (d = 0; d < g; d++) {
            ...
            var m = k;
            k = c;
            for (var n = new JSM.PolyEdgeInfo, p = void 0, q = void 0, p = 0; p < b.edges.length; p++)
                q = b.edges[p], q.vert1 === l && q.vert2 === m ? (n.index = p, n.reverse=!1) : q.vert1 === m && q.vert2 === l && (n.index =
                p, n.reverse=!0);
            - 1 === n.index ? (p = new JSM.EdgeInfo, p.vert1 = l, p.vert2 = m, p.pgon1 = k, p.pgon2 =- 1, b.edges.push(p), n.index = b.edges.length - 1, n.reverse=!1) : (l = b.edges[n.index], - 1 === l.pgon1 ? l.pgon1 = k : l.pgon1 !== k&&-1 === l.pgon2 && (l.pgon2 = k));
            l = n;
            e.verts.push(h);
            e.pedges.push(l);
            b.verts[h].edges.push(l.index);
            b.verts[h].pgons.push(c)
        }
        b.pgons.push(e)
    }
    return b
...
JSM.IsSolidBody = function(a) {
    a = JSM.CalculateAdjacencyInfo(a);
    var b, c;
    for (b = 0; b < a.edges.length; b++)
        if (c = a.edges[b], - 1 === c.pgon1||-1 === c.pgon2)
            return !1;
    return !0
};
    ...
    for (var e; 0 < a.length;)
        if (e = a.pop(), !d[e] && (d[e]=!0, c(e)))
            for (var f = b, g = a, h = f.pgons[e], k = void 0, l = void 0, l = void 0, k = 0; k < h.pedges.length; k++)
                l = f.edges[h.pedges[k].index], l = JSM.GetAnotherPgonOfEdge(l, e), - 1 != l && g.push(l)
};
JSM.AddVertexToBody = function(a, b, c, d) {
    a.AddVertex(new JSM.BodyVertex(new JSM.Coord(b, c, d)))
};
JSM.AddPolygonToBody = function(a, b) {
    a.AddPolygon(new JSM.BodyPolygon(b))
};
JSM.CalculateBodyPolygonNormal = function(a, b) {
    var c = a.GetPolygon(b), d = c.VertexIndexCount(), e = new JSM.Vector(0, 0, 0);
    if (3 <= d) {
        var f, g, h;
        for (f = 0; f < d; f++)
            g = f, h = (f + 1)%d, g = a.GetVertexPosition(c.GetVertexIndex(g)), h = a.GetVertexPosition(c.GetVertexIndex(h)), e.x += (g.y - h.y) * (g.z + h.z), e.y += (g.z - h.z) * (g.x + h.x), e.z += (g.x - h.x) * (g.y + h.y)
    }
    return JSM.VectorNormalize(e)
};
        ...
        if (h = a.GetPolygon(e), b[e] = [], h.HasCurveGroup()) {
            ...
            for (f = 0; f < h.VertexIndexCount(); f++) {
                ...
                for (g = 0; g < m.length; g++)
                    n = a.GetPolygon(m[g]), n.GetCurveGroup() === h.GetCurveGroup() && (k = JSM.CoordAdd(k, c[m[g]]), l++);
                    k = JSM.VectorMultiply(k, 1 / l);
                    k = JSM.VectorNormalize(k);
                    b[e].push(k)
                }
        } else {
            g =
...
JSM.MakeBodyInsideOut = function(a) {
    ...
    for (b = 0; b < a.PolygonCount(); b++) {
        d = a.GetPolygon(b);
        f = d.vertices.slice(0);
        e = f.length;
        d.vertices = [];
        for (c = 0; c < e; c++)
            d.vertices.push(f[e - c - 1])
    }
};
JSM.SoftMoveBodyVertex = function(a, b, c, d, e) {
    b = a.GetVertex(b).position;
    var f = JSM.GetGaussianCParameter(c, e, 0, 1E-5), g, h, k;
    for (g = 0; g < a.VertexCount(); g++)
        h = JSM.CoordDistance(b, a.GetVertex(g).position), JSM.IsGreater(h, c) || (h = JSM.GetGaussianValue(h, e, 0, f), k = a.GetVertex(g).position, a.GetVertex(g).position = JSM.CoordOffset(k, d, h))
    };
JSM.CalculatePolygonCentroid = function(a, b) {
    ...
    return e = JSM.VectorMultiply(e, 1 / d)
};
JSM.TriangulateWithCentroids = function(a) {
    var b = new JSM.Body, c, d;
    for (c = 0; c < a.VertexCount(); c++)
        d = a.GetVertex(c).position, b.AddVertex(new JSM.BodyVertex(new JSM.Coord(d.x, d.y, d.z)));
    var e, f, g, h, k;
    for (c = 0; c < a.PolygonCount(); c++) {
        d = JSM.CalculatePolygonCentroid(a, c);
        k = b.VertexCount();
        b.AddVertex(new JSM.BodyVertex(new JSM.Coord(d.x, d.y, d.z)));
        f = a.GetPolygon(c);
        g = f.VertexIndexCount();
        for (d = 0; d < g; d++)
            e = f.GetVertexIndex(d), h = f.GetVertexIndex(d < g - 1 ? d + 1 : 0), e = new JSM.BodyPolygon([e, h, k]), e.material = f.material,
            e.curved = f.curved, b.AddPolygon(e)
    }
    return b
};
JSM.TriangulatePolygons = function(a) {
    var b = new JSM.Body, c, d, e;
    for (c = 0; c < a.VertexCount(); c++)
        e = a.GetVertexPosition(c), b.AddVertex(new JSM.BodyVertex(new JSM.Coord(e.x, e.y, e.z)));
    var f, g;
    for (c = 0; c < a.PolygonCount(); c++) {
        f = new JSM.Polygon;
        g = a.GetPolygon(c);
        for (d = 0; d < g.VertexIndexCount(); d++)
            e = a.GetVertexPosition(g.GetVertexIndex(d)), f.AddVertex(e.x, e.y, e.z);
        e = JSM.PolygonTriangulate(f);
        for (d = 0; d < e.length; d++)
            f = e[d], f = new JSM.BodyPolygon([g.GetVertexIndex(f[0]), g.GetVertexIndex(f[1]), g.GetVertexIndex(f[2])]),
            f.InheritAttributes(g), b.AddPolygon(f)
    }
    return b
};
JSM.GenerateRandomMaterials = function(a, b, c) {
    ...
    for (d = 0; d < a.PolygonCount(); d++)
        e = void 0 !== c && c ? JSM.SeededRandomInt(0, 16777215, d + 1) : JSM.RandomInt(0, 16777215), e = b.AddMaterial(new JSM.Material({
        ambient: e,
        diffuse: e
    })), a.GetPolygon(d).SetMaterialIndex(e)
};
JSM.AddBodyToBSPTree = function(a, b, c) {
    ...
    for (d = 0; d < a.PolygonCount(); d++) {
        ...
        e = a;
        var g = f, h = e.GetPolygon(d);
        g.material = h.GetMaterialIndex();
        for (var g = new JSM.Polygon, k = void 0, l = void 0, k = 0; k < h.VertexIndexCount();
        k++)l = e.GetVertexPosition(h.GetVertexIndex(k)), g.AddVertex(l.x, l.y, l.z);
        e = g;
        b.AddPolygon(e, f)
    }
};
JSM.MergeCoplanarPolygons = function(a) {
    function b(a, b, c, d, e) {
        function f(a, b, c) {
            ...
            for (d = 0; d < a.length; d++) {
                k = b.pgons[a[d]];
                for (e = 0; e < k.pedges.length; e++)
                    if (l = k.pedges[e], m = b.edges[l.index], !g[m.pgon1] ||!g[m.pgon2])
                        l.reverse ? (l = m.vert2, m = m.vert1) : (l = m.vert1, m = m.vert2), c[l] = m, - 1 == h && (h = l)
            }
            return h
        }
        function g(a, b, c, d) {
            ...
            for (f = 0; f < c.length; f++)
                h = c[f], k = d[h], void 0 === k && (k = a.GetVertexPosition(h), k = b.AddVertex(new JSM.BodyVertex(k.Clone())),
            d[h] = k), e.push(k);
            b.AddPolygon(new JSM.BodyPolygon(e))
        }
        if (0 !== c.length) {
            var h = [];
            if (1 == c.length)
                h = a.GetPolygon(c[0]).GetVertexIndices();
            else {
                var v = [];
                b = f(c, b, v);
                if ( - 1 == b)
    ...
    var c = new JSM.Body, d = JSM.CalculateAdjacencyInfo(a), e = function(a, b) {
        function c(a, b, d, e) {
            if (e[a])
                return null;
            var f = [], g;
            JSM.TraversePgonsAlongEdges(a, b, function(b) {
                g = JSM.GetVectorsAngle(d[a], d[b]);
                return JSM.IsEqual(g, 0) ? (f.push(b), e[b]=!0) : !1
            });
            return f
        }
        var d =
        JSM.CalculateBodyPolygonNormals(a), e = [], f = {}, g;
        for (g = 0; g < b.pgons.length; g++)
            h = c(g, b, d, f), null !== h && e.push(h);
        return e
    }(a, d), f = {}, g, h;
...
JSM.CalculatePlanarTextureCoord = function(a, b) {
    var c = new JSM.Coord2D(0, 0), d = JSM.VectorNormalize(b.e1), e = JSM.VectorNormalize(b.e2), f = JSM.VectorCross(b.e1, b.e2), f = JSM.GetPlaneFromCoordAndDirection(b.origo, f), e = JSM.GetPlaneFromCoordAndDirection(b.origo, e), d = JSM.GetPlaneFromCoordAndDirection(b.origo, d), f = JSM.ProjectCoordToPlane(a, f);
    c.x = JSM.CoordPlaneSignedDistance(f, d);
    c.y = JSM.CoordPlaneSignedDistance(f, e);
    return c
};
JSM.CalculateCubicTextureCoord = function(a, b, c) {
    var d = new JSM.Coord2D(0, 0), e = JSM.VectorNormalize(c.e1), f = JSM.VectorNormalize(c.e2), g = JSM.VectorNormalize(c.e3), h =- 1, k = 0, l, m, n;
    for (l = 0; 3 > l; l++)
        0 === l ? m = e : 1 === l ? m = f : 2 === l && (m = g), n = Math.abs(JSM.VectorDot(b, m)), JSM.IsGreater(n, k) && (h = l, k = n);
    if ( - 1 === h)
        return d;
    b = null;
...
JSM.CalculateCylindricalTextureCoord = function(a, b, c) {
    var d = new JSM.Coord2D(0, 0), e = JSM.VectorNormalize(c.e3);
    if (JSM.VectorsAreCollinear(e, b))
        return d = JSM.CalculateCubicTextureCoord(a, b, c), [d, 0];
    b = new JSM.Line(c.origo, e);
    var f = JSM.ProjectCoordToLine(a, b);
    b = JSM.CoordSignedDistance(c.origo, f, e);
    var g = JSM.VectorNormalize(c.e1);
    a = JSM.CoordSub(a, f);
    e = JSM.GetVectorsFullAngle(a, g, e);
    c = JSM.VectorLength(c.e1);
    d.x = e * c;
    d.y = b;
    return [d, e]
};
JSM.CalculatePolygonPlanarTextureCoords = function(a, b) {
    var c = [], d = a.GetPolygon(b), e = a.GetTextureProjectionCoords(), f, g;
    for (f = 0; f < d.VertexIndexCount(); f++)
        g = a.GetVertexPosition(d.GetVertexIndex(f)), c.push(JSM.CalculatePlanarTextureCoord(g, e));
    return c
};
JSM.CalculatePolygonCubicTextureCoords = function(a, b, c) {
    var d = [];
    b = a.GetPolygon(b);
    var e = a.GetTextureProjectionCoords(), f, g;
    for (f = 0; f < b.VertexIndexCount(); f++)
        g = a.GetVertexPosition(b.GetVertexIndex(f)), d.push(JSM.CalculateCubicTextureCoord(g, c, e));
    return d
};
JSM.CalculatePolygonCylindricalTextureCoords = function(a, b, c) {
    var d = [], e = [], f = a.GetPolygon(b);
    b = a.GetTextureProjectionCoords();
    var g, h;
    for (g = 0; g < f.VertexIndexCount(); g++)
        h = a.GetVertexPosition(f.GetVertexIndex(g)), h = JSM.CalculateCylindricalTextureCoord(h, c, b), d.push(h[0]), e.push(h[1]);
    g = JSM.VectorNormalize(b.e3);
    if (JSM.VectorsAreCollinear(g, c))
        return d;
    a=!1;
    for (g = 0; g < e.length; g++) {
        for (c = g + 1; c < e.length; c++)
            if (JSM.IsGreater(Math.abs(e[g] - e[c]), Math.PI)) {
                a=!0;
                break
            }
        if (a)
    ...
    if (a) {
        b = JSM.VectorLength(b.e1);
        for (g = 0; g < e.length; g++)
            JSM.IsLower(e[g], Math.PI) && (d[g].x = b * (e[g] + 2 * Math.PI))
    }
    return d
};
...
JSM.CalculateBodyCubicTextureCoords = function(a) {
    ...
    for (d = 0; d < a.PolygonCount(); d++)
        e = c[d], b.push(JSM.CalculatePolygonCubicTextureCoords(a, d, e));
    return b
};
JSM.CalculateBodyCylindricalTextureCoords = function(a) {
    var b = [], c = JSM.CalculateBodyPolygonNormals(a), d, e;
    for (d = 0; d < a.PolygonCount(); d++)
        e = c[d], b.push(JSM.CalculatePolygonCylindricalTextureCoords(a, d, e));
    return b
};
JSM.CalculateBodyTextureCoords = function(a) {
    var b = [], c = a.GetTextureProjectionType();
    "Planar" === c ? b = JSM.CalculateBodyPlanarTextureCoords(a) : "Cubic" === c ? b = JSM.CalculateBodyCubicTextureCoords(a) : "Cylindrical" === c && (b = JSM.CalculateBodyCylindricalTextureCoords(a));
    return b
};
JSM.CutBodyByPlane = function(a, b) {
    function c(a, b, c) {
        ...
        function e(c, d) {
            t = JSM.VectorNormalize(JSM.CoordSub(a[d], a[c]));
            M = new JSM.Line(a[c], t);
            H = JSM.LinePlaneIntersection(M, b);
            q.push(new JSM.Coord(H.x, H.y, H.z));
            r.push( - 1)
        }
        var f = void 0 !== c && null !== c, g = a.length, h = [], k = [], l=!1, m, n, p;
        for (m = 0; m < g; m++)
            p = a[m], n = JSM.CoordPlanePosition(p, b), k.push("CoordAtBackOfPlane" !== n), 0 < m && k[m - 1] !== k[m] && (l=!0);
        if (!l) {
            if (!1 === k[0])
                return h;
            for (m = 0; m < g; m++)
                p = a[m], h.push(new JSM.Coord(p.x,
                p.y, p.z)), f && c.push(m);
            return h
        }
        var q = [], r = [], t, M, H;
        for (m = 0; m < g; m++)
            l = m - 1, n = m, 0 === m && (l = g - 1), p = a[n], k[n] ? (k[l] || e(l, n), d(n)) : k[l] && e(l, n);
        for (m = 0; m < q.length; m++)
            g = q[m], k = h[h.length - 1], 0 === m ||!JSM.CoordIsEqual(k, g) ? (h.push(new JSM.Coord(g.x, g.y, g.z)), f && (g = r[m], c.push(g))) : f && (g = r[m], k = r[m - 1], - 1 !== g ? c[c.length - 1] = g : - 1 !== k && (c[c.length - 1] = k));
        return h
    }
    function d(a) {
        var b =- 1, c;
        for (c = r; c < e.VertexCount(); c++)
            if (JSM.CoordIsEqual(e.GetVertexPosition(c), a)) {
                b = c;
                break
            }
        - 1 === b && (b = e.AddVertex(new JSM.BodyVertex(new JSM.Coord(a.x,
        a.y, a.z))));
        return b
    }
    var e = new JSM.Body, f = [], g = [], h = [], k = [], l, m, n, p, q;
    for (l = 0; l < a.PolygonCount(); l++) {
        n = a.GetPolygon(l);
        p = [];
        for (m = 0; m < n.VertexIndexCount(); m++)
            q = a.GetVertexPosition(n.GetVertexIndex(m)), p.push(new JSM.Coord(q.x, q.y, q.z));
        q = [];
        p = c(p, b, q);
        for (m = 0; m < q.length; m++) 
            - 1 !== q[m] && (h[n.GetVertexIndex(q[m])]=!0);
        f.push(p);
        g.push(q)
    }
    var t;
    for (l = 0; l < a.VertexCount(); l++)
        h[l] && (t = a.GetVertexPosition(l), k[l] = e.AddVertex(new JSM.BodyVertex(new JSM.Coord(t.x, t.y, t.z))));
    var r = e.VertexCount();
    for (l =
    0; l < a.PolygonCount(); l++)
        if (n = a.GetPolygon(l), p = f[l], q = g[l], 0 !== q.length) {
            h = [];
            for (m = 0; m < q.length; m++) 
                - 1 !== q[m] ? h.push(k[n.GetVertexIndex(q[m])]) : (t = p[m], h.push(d(t)));
                m = new JSM.BodyPolygon(h);
...
JSM.GenerateRectangle = function(a, b) {
    var c = new JSM.Body, d = a / 2, e = b / 2;
...
JSM.GenerateSegmentedRectangle = function(a, b, c, d) {
    var e = new JSM.Body, f = a / 2, g = b / 2, h = a / c, k = b / d;
    (function() {
        var a, b, n;
        for (a = 0; a <= d; a++)
            for (b = 0; b <= c; b++)
                n = new JSM.Coord(b * h - f, a * k - g, 0), e.AddVertex(new JSM.BodyVertex(n))
    })();
    (function() {
        var a, b, f, g, h, k;
        for (b = 0; b < d; b++)
            for (a = 0; a < c; a++)
                f = b * (c + 1) + a, g = f + 1, h = f + c + 1, k = h + 1, e.AddPolygon(new JSM.BodyPolygon([f, g, k, h]))
    })();
    return e
};
JSM.GenerateSegmentedCuboid = function(a, b, c, d) {
    ...
    function g(a) {
        ...
        d)
            for (a = 0; a <= d; a++)
                for (b = 0; b <= d; b++)
                    c = new JSM.Coord(b * p - l, a * q - m, e - n), k.AddVertex(new JSM.BodyVertex(c));
        else if (0 < a && a < d)
            for (a = 0; a <= d; a++)
                for (b = 0; b <= d; b++)
                    if (0 === a || a === d || 0 === b || b === d)
    ...
    function h(a) {
        ...
        if (0 === a || a === d) {
            ...
            for (b = 0; b < d; b++)
                for (c = 0; c < d; c++)
                    f = m + b * (d + 1) + c, g = f + 1, h = f + d + 1, l = h + 1, 0 === a ? k.AddPolygon(new JSM.BodyPolygon([f, h, l, g])) : k.AddPolygon(new JSM.BodyPolygon([f, g, l, h]))
        }
        if (0 < a && a <= d) {
            c = r[a - 1];
            a = r[a];
            for (b = 0; b < 4 * d; b++)
                f = c[b], h = a[b], b < 4 * d - 1 ? (g = c[b + 1], l = a[b + 1]) : (g = c[0], l = a[0]), k.AddPolygon(new JSM.BodyPolygon([f, g, l, h]))
        }
    }
    var k = new JSM.Body, l = a / 2, m = b / 2, n = c / 2, p = a / d, q = b / d, t = c / d;
    for (a = 0; a <= d; a++)
        g(a);
    var r = [];
    for (a = 0; a <= d; a++)
...
JSM.GenerateSphere = function(a, b, c) {
    ...
    for (k = 1; k < b; k++) {
        for (l = m = 0; l < e; l++)
            d.AddVertex(new JSM.BodyVertex(JSM.SphericalToCartesian(a, h, m))), m += g;
        h += g
    }
    ...
    for (k = 1; k <= b; k++)
        if (1 === k) {
            g = 1;
            for (l = 0; l < e; l++)
                h = g + l, m = h + 1, l === e - 1 && (m = g), h = new JSM.BodyPolygon([h, m, f]), c && h.SetCurveGroup(0), d.AddPolygon(h)
        } else if (k < b) {
            g = (k - 1) * e +
            1;
            for (l = 0; l < e; l++)
                h = g + l, m = h + 1, n = h - e, p = n + 1, l === e - 1 && (m = g, p = g - e), h = new JSM.BodyPolygon([h, m, p, n]), c && h.SetCurveGroup(0), d.AddPolygon(h)
        } else if (k === b) {
            g = (k - 2) * e + 1;
            for (l = 0; l < e; l++)
                h = g + l, m = h + 1, l === e - 1 && (m = g), h = new JSM.BodyPolygon([h, a, m]), c && h.SetCurveGroup(0), d.AddPolygon(h)
        }
...
JSM.GenerateTriangulatedSphere = function(a, b, c) {
    ...
    for (var e = JSM.VectorLength(d.GetVertexPosition(0)), f = a / e, g, h, e = 0; e < d.VertexCount(); e++)
        h = d.GetVertex(e), h.SetPosition(JSM.VectorMultiply(h.GetPosition(), f));
    for (var k, l, m, n, f = 0; f < b; f++) {
        g = d;
        d = new JSM.Body;
        h = JSM.CalculateAdjacencyInfo(g);
        for (e = 0; e < h.verts.length; e++)
            k = g.GetVertexPosition(e), JSM.AddVertexToBody(d, k.x, k.y, k.z);
        k = [];
        for (e = 0; e < h.edges.length; e++)
            l = h.edges[e], l = JSM.MidCoord(g.GetVertexPosition(l.vert1), g.GetVertexPosition(l.vert2)),
            l = JSM.VectorMultiply(JSM.VectorNormalize(l), a), k.push(d.AddVertex(new JSM.BodyVertex(l)));
        for (e = 0; e < h.pgons.length; e++) {
            l = h.pgons[e];
            m = [];
            for (g = 0; g < l.pedges.length; g++)
                n = l.pedges[g], m.push(JSM.GetPolyEdgeStartVertex(n, h)), m.push(k[n.index]);
    ...
    d.SetCubicTextureProjection(new JSM.Coord(0,
...
JSM.GenerateCylinder = function(a, b, c, d, e) {
    ...
    for (k = 0; k < c; k++)
        f.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, b / 2, g))), f.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, - b / 2, g))), g -= h;
    for (k = 0; k < c; k++)
        g = 2 * k, h = g + 2, k === c - 1 && (h = 0), g = new JSM.BodyPolygon([g, h, h + 1, g + 1]), e && g.SetCurveGroup(0), f.AddPolygon(g);
    if (d) {
        d = new JSM.BodyPolygon([]);
        e = new JSM.BodyPolygon([]);
        for (k = 0; k < c; k++)
            d.AddVertexIndex(2 * (c - k - 1)), e.AddVertexIndex(2 * k + 1);
        f.AddPolygon(d);
        f.AddPolygon(e)
    }
...
JSM.GeneratePie = function(a, b, c, d, e, f) {
    var g = new JSM.Body, h = c, k = c / (d - 1);
    g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(0, b / 2, 0)));
    g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(0, - b / 2, 0)));
    for (c = 0; c < d; c++)
        g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, b / 2, h))), g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, - b / 2, h))), h -= k;
    for (c = 0; c <= d; c++)
        h = 2 * c, k = h + 2, c === d && (k = 0), h = new JSM.BodyPolygon([h, k, k + 1, h + 1]), f && (0 < c && c < d) && h.SetCurveGroup(0), g.AddPolygon(h);
    if (e) {
        e =
        new JSM.BodyPolygon([]);
        f = new JSM.BodyPolygon([]);
        for (c = 0; c <= d; c++)
            e.AddVertexIndex(2 * (d - c)), f.AddVertexIndex(2 * c + 1);
        g.AddPolygon(e);
        g.AddPolygon(f)
    }
...
JSM.GenerateCone = function(a, b, c, d, e, f) {
    var g = new JSM.Body, h = JSM.IsZero(a), k = JSM.IsZero(b), l = 2 * Math.PI, m = 2 * Math.PI / d;
    h && g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(0, c / 2, 0)));
    var n;
    for (n = 0; n < d; n++)
        h || g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(a, c / 2, l))), k || g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(b, - c / 2, l))), l -= m;
    k && g.AddVertex(new JSM.BodyVertex(JSM.CylindricalToCartesian(0, - c / 2, 0)));
    for (n = 0; n < d; n++)
        h ? (l = n + 1, m = l + 1, n === d - 1 && (m = 1), l = new JSM.BodyPolygon([0,
        m, l])) : k ? (l = n, m = l + 1, n === d - 1 && (m = 0), l = new JSM.BodyPolygon([l, m, d])) : (l = 2 * n, m = l + 2, n === d - 1 && (m = 0), l = new JSM.BodyPolygon([l, m, m + 1, l + 1])), f && l.SetCurveGroup(0), g.AddPolygon(l);
    if (e)
        if (h) {
            f = new JSM.BodyPolygon([]);
            for (n = 0; n < d; n++)
            ...
            f = new JSM.BodyPolygon([]);
            for (n = 0; n < d; n++)
                e.AddVertexIndex(2 * (d - n - 1)), f.AddVertexIndex(2 * n + 1);
                g.AddPolygon(e);
                g.AddPolygon(f)
        }
...
JSM.GeneratePrism = function(a, b, c, d) {
    var e = new JSM.Body, f = a.length, g;
    for (g = 0; g < f; g++)
        e.AddVertex(new JSM.BodyVertex(a[g])), e.AddVertex(new JSM.BodyVertex(JSM.CoordOffset(a[g], b, c)));
    var h;
    for (g = 0; g < f; g++)
        c = 2 * g, h = c + 2, g === f - 1 && (h = 0), e.AddPolygon(new JSM.BodyPolygon([c, h, h + 1, c + 1]));
    if (d) {
        d = new JSM.BodyPolygon([]);
        c = new JSM.BodyPolygon([]);
        for (g = 0; g < f; g++)
            d.AddVertexIndex(2 * g + 1), c.AddVertexIndex(2 * (f - g - 1));
        e.AddPolygon(d);
        e.AddPolygon(c)
    }
    f = JSM.VectorNormalize(JSM.CoordSub(a[1], a[0]));
    a = new JSM.Coord(a[0].x,
    a[0].y, a[0].z);
    b = JSM.VectorNormalize(b);
    f = JSM.VectorCross(b, f);
    g = JSM.VectorCross(f, b);
    e.SetCubicTextureProjection(a, g, f, b);
    return e
};
JSM.GenerateCurvedPrism = function(a, b, c, d, e) {
    c = JSM.GeneratePrism(a, c, d, e);
    if (void 0 === b || null === b || a.length != b.length)
        return c;
    for (d = 0; d < a.length; d++)
        e = b[d], c.GetPolygon(d).SetCurveGroup(e);
    return c
};
JSM.GeneratePrismWithHole = function(a, b, c, d) {
    function e() {
        var b = 0, c = [], d;
        for (d = 0; d < a.length; d++)
            null === a[d] && (b += 1), c.push(d - b);
        var b = JSM.CreatePolygonWithHole(a), e = new JSM.Polygon, g;
        for (d = 0; d < b.length; d++)
            g = a[b[d]], e.AddVertex(g.x, g.y, g.z);
        g = JSM.PolygonTriangulate(e);
        var h, k, v;
        for (d = 0; d < g.length; d++) {
            h = g[d];
            k = new JSM.BodyPolygon([]);
            v = new JSM.BodyPolygon([]);
            for (e = 0; 3 > e; e++)
                k.AddVertexIndex(2 * c[b[h[e]]] + 1), v.AddVertexIndex(2 * c[b[h[3 - e - 1]]]);
            f.AddPolygon(k);
            f.AddPolygon(v)
        }
    }
    ...
    (function() {
        var d;
        for (d = 0; d < a.length; d++)
            null !== a[d] && (f.AddVertex(new JSM.BodyVertex(a[d])), f.AddVertex(new JSM.BodyVertex(JSM.CoordOffset(a[d], b, c))))
    })();
    (function() {
        var b = 0, c = [];
        c.push(0);
        var d;
        for (d = 0; d < a.length; d++)
            null === a[d] && (c.push(d - b), b += 1);
        c.push(d - b);
        for (b = 0; b < c.length - 1; b++) {
            var e = d = void 0, g = void 0, h = c[b], k = c[b + 1];
            for (d = h; d < k; d++)
                e = 2 * d, g = e + 2, d === k - 1 && (g = 2 * h), f.AddPolygon(new JSM.BodyPolygon([e, g, g + 1, e + 1]))
        }
    })();
    d && e();
    var g = JSM.VectorNormalize(JSM.CoordSub(a[1], a[0]));
    d = new JSM.Coord(a[0].x, a[0].y, a[0].z);
    var h = JSM.VectorNormalize(b), g = JSM.VectorCross(h, g), k = JSM.VectorCross(g, h);
    f.SetCubicTextureProjection(d, k, g, h);
    return f
};
JSM.GenerateCurvedPrismWithHole = function(a, b, c, d, e) {
    c = JSM.GeneratePrismWithHole(a, c, d, e);
    if (void 0 === b || null === b || a.length != b.length)
        return c;
    d = 0;
    var f;
    for (e = 0; e < a.length; e++)
        f = b[e], null !== f && (c.GetPolygon(d).SetCurveGroup(f), d++);
    return c
};
JSM.GeneratePrismShell = function(a, b, c, d, e) {
    ...
    var k;
    for (h = 0; h < g; h++)
        k = JSM.CoordOffset(a[h], b, c), f.AddVertex(new JSM.BodyVertex(k));
    for (h = 0; h < g; h++)
        k = JSM.CoordOffset(d[h], b, c), f.AddVertex(new JSM.BodyVertex(k));
    var l;
    for (h = 0; h < g; h++)
        c = h, d = c + 1, k = c + 2 * g, l = k + 1, h === g - 1 && (d = 0, l = 2 * g), f.AddPolygon(new JSM.BodyPolygon([c,
        d, l, k])), f.AddPolygon(new JSM.BodyPolygon([c + g, k + g, l + g, d + g]));
    if (e)
        for (h = 0; h < g; h++)
            c = h, d = c + 1, k = h + g, l = k + 1, h === g - 1 && (d = 0, l = g), f.AddPolygon(new JSM.BodyPolygon([c, k, l, d])), f.AddPolygon(new JSM.BodyPolygon([c + 2 * g, d + 2 * g, l + 2 * g, k + 2 * g]));
    e = JSM.VectorNormalize(JSM.CoordSub(a[1], a[0]));
...
JSM.GenerateCylinderShell = function(a, b, c, d, e, f) {
    for (var g = new JSM.Vector(0, 0, 1), h =- b / 2, k = [], l = 2 * Math.PI / d, m, n = 0, n = 0; n < d; n++)
        m = n * l, m = JSM.PolarToCartesian(a, m), k.push(new JSM.Coord(m.x, m.y, h));
    a = JSM.GeneratePrismShell(k, g, b, c, e);
    if (f)
        for (f = 0; f < d; f++)
            a.GetPolygon(2 * f).SetCurveGroup(0), a.GetPolygon(2 * f + 1).SetCurveGroup(0);
    return a
};
JSM.GenerateLineShell = function(a, b, c, d, e, f) {
    var g = new JSM.Body, h = a.length, k = [], l, m, n, p, q, t;
    for (l = 0; l < h; l++)
        0 === l || l === h - 1 ? q = Math.PI / 2 : (m = l - 1, n = l, p = l + 1, t = JSM.CoordSub(a[p], a[n]), q = JSM.CoordSub(a[m], a[n]), q = JSM.GetVectorsAngle(t, q) / 2, "Clockwise" === JSM.CoordTurnType(a[m], a[n], a[p], b) && (q = Math.PI - q)), k.push(q);
    t = new JSM.Vector(0, 0, 1);
    m = [];
    var r;
    for (l = 0; l < h; l++)
        n = l, l === h - 1 ? r = JSM.CoordSub(a[n - 1], a[n]) : (p = (l + 1)%h, r = JSM.CoordSub(a[n], a[p])), q = k[n], p = d / Math.sin(q), p = JSM.CoordOffset(a[n], r, p), p = JSM.CoordRotate(p,
        t, - (Math.PI - q), a[n]), m.push(p);
    for (l = 0; l < h; l++)
        g.AddVertex(new JSM.BodyVertex(a[l]));
    for (l = 0; l < h; l++)
        g.AddVertex(new JSM.BodyVertex(m[l]));
    for (l = 0; l < h; l++)
        n = JSM.CoordOffset(a[l], b, c), g.AddVertex(new JSM.BodyVertex(n));
    for (l = 0; l < h; l++)
        n = JSM.CoordOffset(m[l], b, c), g.AddVertex(new JSM.BodyVertex(n));
    for (l = 0; l < h - 1; l++)
        n = l, p = n + 1, c = n + 2 * h, d = c + 1, g.AddPolygon(new JSM.BodyPolygon([n, p, d, c])), g.AddPolygon(new JSM.BodyPolygon([n + h, c + h, d + h, p + h]));
    e && (n = 0, g.AddPolygon(new JSM.BodyPolygon([n, n + 2 * h, n + 3 * h, n + h])), n =
    h - 1, g.AddPolygon(new JSM.BodyPolygon([n, n + h, n + 3 * h, n + 2 * h])));
    if (f)
        for (l = 0; l < h - 1; l++)
            n = l, p = n + 1, c = l + h, d = c + 1, g.AddPolygon(new JSM.BodyPolygon([n, c, d, p])), g.AddPolygon(new JSM.BodyPolygon([n + 2 * h, p + 2 * h, d + 2 * h, c + 2 * h]));
    e = JSM.VectorNormalize(JSM.CoordSub(a[1], a[0]));
    a = new JSM.Coord(a[0].x, a[0].y, a[0].z);
    b = JSM.VectorNormalize(b);
    e = JSM.VectorCross(b, e);
...
JSM.GenerateTorus = function(a, b, c, d, e) {
    ...
    for (l = 0; l < d; l++)
        m = JSM.PolarToCartesian(b, g), m = new JSM.Coord(m.x + a, 0, m.y), k.push(m), g += h;
    b = new JSM.Coord(0, 0, 1);
    g = new JSM.Coord(0, 0, 0);
    h = 2 * Math.PI / c;
    for (l = 0; l < c; l++)
        for (a = 0; a < d; a++)
            m = JSM.CoordRotate(k[a], b, l * h, g), f.AddVertex(new JSM.BodyVertex(m));
    for (l = 0; l < c; l++) {
        new JSM.BodyPolygon([]);
        for (a = 0; a < d; a++)
            h = l * d + a, b = h + d, k = h + 1, g = b + 1, a === d - 1 && (k = l * d, g = (l + 1) * d), l === c - 1 && (b = a, g = a + 1, a === d - 1 && (g = 0)), h = new JSM.BodyPolygon([h,
            b, g, k]), e && h.SetCurveGroup(0), f.AddPolygon(h)
    }
...
JSM.GeneratePolyTorus = function(a, b, c, d) {
    ...
    for (k = 0; k < f; k++)
        g = a[k], g = new JSM.Coord(g.x + b, 0, g.y), h.push(g);
    b = new JSM.Coord(0, 0, 1);
    var l = new JSM.Coord(0, 0, 0), g = 2 * Math.PI / c, m;
    for (k = 0; k < c; k++)
        for (a = 0; a < f; a++)
            m = JSM.CoordRotate(h[a], b, k * g, l), e.AddVertex(new JSM.BodyVertex(m));
    for (k = 0; k < c; k++) {
        new JSM.BodyPolygon([]);
        for (a = 0; a < f; a++)
            h = k * f + a, b = h + f, g = h + 1, l = b + 1, a === f - 1 && (g = k * f, l = (k + 1) * f), k === c - 1 && (b = a, l = a + 1, a === f - 1 && (l = 0)), h = new JSM.BodyPolygon([h, b, l, g]), d && h.SetCurveGroup(a),
            e.AddPolygon(h)
    }
...
JSM.GenerateRuledFromSectors = function(a, b, c, d, e) {
    var f = new JSM.Body, g = [], h = [];
    JSM.GetSectorSegmentation(a, c, g);
    JSM.GetSectorSegmentation(b, c, h);
    b = [];
    a = [];
    JSM.GetRuledMesh(g, h, d, b, a);
    for (d = 0; d < b.length; d++)
        f.AddVertex(new JSM.BodyVertex(b[d]));
    for (d = 0; d < a.length; d++)
        g = a[d], g = new JSM.BodyPolygon(g), e && g.SetCurveGroup(0), f.AddPolygon(g);
    f.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
    return f
};
...
JSM.GenerateRuledFromSectorsWithHeight = function(a, b, c, d, e, f) {
    var g = new JSM.Body, h = [], k = [];
    JSM.GetSectorSegmentation(a, c, h);
    JSM.GetSectorSegmentation(b, c, k);
    b = [];
    a = [];
    JSM.GetRuledMesh(h, k, d, b, a);
    for (h = 0; h < b.length; h++)
        g.AddVertex(new JSM.BodyVertex(b[h]));
    for (var l, h = 0; h < a.length; h++)
        l = a[h], l = new JSM.BodyPolygon(l), e && l.SetCurveGroup(0), g.AddPolygon(l);
    k = g.VertexCount();
    for (h = 0; h < b.length; h++)
        l = b[h], l = new JSM.Coord(l.x, l.y, l.z), l.z -= f, g.AddVertex(new JSM.BodyVertex(l));
    for (h = 0; h < a.length; h++) {
        l = a[h];
        b = [];
        for (f = l.length - 1; 0 <= f; f--)
            b.push(l[f] + k);
        l = new JSM.BodyPolygon(b);
        e && l.SetCurveGroup(0);
        g.AddPolygon(l)
    }
    for (h = 0; h < d; h++)
        e = h + k, f = e + 1, a = e - k, b = a + 1, l = new JSM.BodyPolygon([e, f, b, a]), g.AddPolygon(l);
    for (h = 0; h < d; h++)
        e = h + c * (d + 1) + k, f = e + 1, a = e - k, b = a + 1, l = new JSM.BodyPolygon([e, a, b, f]), g.AddPolygon(l);
    for (h = 0; h < c; h++)
        e = h * (d + 1) + k, f = e + d + 1, a = e - k, b = a + d + 1, l = new JSM.BodyPolygon([e, a, b, f]), g.AddPolygon(l);
    for (h = 0; h < c; h++)
        e = (h + 1) * d + h + k, f = e + d + 1, a = e - k, b = a + d + 1, l = new JSM.BodyPolygon([e, f, b, a]), g.AddPolygon(l);
    g.SetCubicTextureProjection(new JSM.Coord(0,
    0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
    return g
};
JSM.GenerateRuledFromCoords = function(a, b, c, d) {
    var e = new JSM.Body, f = [], g = [];
    JSM.GetRuledMesh(a, b, c, f, g);
    for (a = 0; a < f.length; a++)
        e.AddVertex(new JSM.BodyVertex(f[a]));
    for (a = 0; a < g.length; a++)
        f = g[a], f = new JSM.BodyPolygon(f), d && f.SetCurveGroup(0), e.AddPolygon(f);
    e.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
    return e
};
JSM.GenerateRevolved = function(a, b, c, d, e, f) {
    var g = new JSM.Body, h = JSM.IsEqual(c, 2 * Math.PI), k = a.length, l = c / d;
    c = JSM.CoordSub(b.end, b.beg);
    var m, n, p;
    for (m = 0; m < k; m++)
        for (n = 0; n <= d; n++)
            h && n === d || (p = JSM.CoordRotate(a[m], c, n * l, b.beg), g.AddVertex(new JSM.BodyVertex(p)));
    l = 0;
    "CurveSegments" == f ? l = 1 : "CurveAll" == f && (l = 2);
    var q, t;
    for (m = 0; m < k - 1; m++)
        for (n = 0; n < d; n++)
            f = m * (d + 1) + n, p = f + d + 1, q = f + 1, t = p + 1, h && (f = m * d + n, p = f + d, q = f + 1, t = p + 1, n === d - 1 && (q = m * d, t = (m + 1) * d)), f = new JSM.BodyPolygon([f, q, t, p]), 1 == l ? f.SetCurveGroup(m) : 2 == l &&
            f.SetCurveGroup(0), g.AddPolygon(f);
    if (h && e) {
        e = new JSM.BodyPolygon([]);
        h = new JSM.BodyPolygon([]);
        for (m = 0; m < d; m++)
            e.AddVertexIndex(d * (k - 1) + m), h.AddVertexIndex(d - m - 1);
        g.AddPolygon(e);
        g.AddPolygon(h)
    }
    e = new JSM.Line(b.beg, JSM.VectorNormalize(c));
    for (m = d = 0; m < k; m++)
        h = JSM.ProjectCoordToLine(a[m], e), d += JSM.CoordDistance(h, a[m]);
    d/=k;
    b = new JSM.Coord(b.beg.x, b.beg.y, b.beg.z);
    k = JSM.VectorNormalize(c);
    c = new JSM.Line(b, c);
    c = JSM.ProjectCoordToLine(a[0], c);
    a = JSM.VectorNormalize(JSM.CoordSub(a[0], c));
    g.SetCylindricalTextureProjection(b,
    d, a, k);
    return g
};
JSM.GenerateTube = function(a, b) {
    ...
    for (g = 0; g < d - 1; g++)
        for (f = 0; f < e; f++)
            h = g + d * f, k = h + d, f === e - 1 && (k = g), c.AddPolygon(new JSM.BodyPolygon([h, k, k + 1, h + 1]));
    if (b) {
...
JSM.GenerateFunctionSurface = function(a, b, c, d, e) {
    ...
    for (e = 0; e < d.VertexCount(); e++)
        f = d.GetVertexPosition(e), f.z = a(f.x, f.y);
    d.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
    return d
};
JSM.GenerateFunctionSurfaceSolid = function(a, b, c, d, e, f) {
    ...
    g = (d + 1) * (d + 1);
    for (d = 0; d < g; d++)
        f = e.GetVertexPosition(d), f.z = a(f.x, f.y);
    e.SetCubicTextureProjection(new JSM.Coord(0, 0, 0), new JSM.Coord(1, 0, 0), new JSM.Coord(0, 1, 0), new JSM.Coord(0, 0, 1));
    return e
};
...
JSM.ExplodeBodyToTriangles = function(a, b, c) {
    if (void 0 === c || null === c)
        return !1;
    var d = JSM.CalculateBodyVertexNormals(a), e, f, g=!1;
    if (void 0 !== b && null !== b)
        for (e = 0; e < b.Count(); e++)
            if (null !== b.GetMaterial(e).texture) {
                g=!0;
                break
            }
    var h, k;
    if (g) {
        h = JSM.CalculateBodyTextureCoords(a);
        for (e = 0; e < h.length; e++)
            if (f = a.GetPolygon(e), f.HasMaterialIndex()) {
                k = b.GetMaterial(f.GetMaterialIndex());
                for (f = 0; f < h[e].length; f++)
                    h[e][f].x/=k.textureWidth, h[e][f].y/=-k.textureHeight
            }
    }
    var l=!0;
    void 0 !== c.hasConvexPolygons && null !==
    c.hasConvexPolygons && (l = c.hasConvexPolygons);
    (function(a, b, c, d, e) {
        function f(h, k) {
            var s = b.GetMaterial(k);
            if (void 0 !== e.onGeometryStart && null !== e.onGeometryStart)
                e.onGeometryStart(s);
            var r;
            for (r = 0; r < h.length; r++) {
                var v = h[r], x = a.GetPolygon(v), u = x.VertexIndexCount();
                if (!(3 > u)) {
                    var F = void 0, C = void 0, D = void 0, J = void 0, O = void 0, M = void 0, H = void 0, G = void 0, I = void 0, K = void 0;
                    if (3 == u || l)
                        for (K = 0; K < u - 2; K++) {
                            if (F = a.GetVertex(x.GetVertexIndex(0)).position, C = a.GetVertex(x.GetVertexIndex((K + 1)%u)).position, D = a.GetVertex(x.GetVertexIndex((K +
                            2)%u)).position, J = c[v][0], O = c[v][(K + 1)%u], M = c[v][(K + 2)%u], I = G = H = null, g && (H = d[v][0], G = d[v][(K + 1)%u], I = d[v][(K + 2)%u]), void 0 !== e.onTriangle && null !== e.onTriangle)
                                e.onTriangle(F, C, D, J, O, M, H, G, I)
                            } else {
                        F = new JSM.Polygon;
                        C = void 0;
                        for (K = 0; K < u; K++)
                            C = a.GetVertex(x.vertices[K]), F.AddVertex(C.position.x, C.position.y, C.position.z);
                        for (var K = JSM.CalculateBodyPolygonNormal(a, v), u = JSM.PolygonTriangulate(F, K), P = void 0, K = 0; K < u.length; K++)
                            if (P = u[K], F = a.GetVertex(x.GetVertexIndex(P[0])).position, C = a.GetVertex(x.GetVertexIndex(P[1])).position,
                            D = a.GetVertex(x.GetVertexIndex(P[2])).position, J = c[v][P[0]], O = c[v][P[1]], M = c[v][P[2]], I = G = H = null, g && (H = d[v][P[0]], G = d[v][P[1]], I = d[v][P[2]]), void 0 !== e.onTriangle && null !== e.onTriangle)
                                e.onTriangle(F, C, D, J, O, M, H, G, I)
                            }
                        }
                }
            if (void 0 !== e.onGeometryEnd && null !== e.onGeometryEnd)
                e.onGeometryEnd(s)
        }
        var h, k = [], s = [];
        if (void 0 === b || null === b)
        ...
        for (h = 0; h < a.PolygonCount(); h++)
            x = a.GetPolygon(h), x.HasMaterialIndex() ? (x = x.GetMaterialIndex(), k[x].push(h)) : s.push(h);
        for (h = 0; h < k.length; h++)
            x = k[h], 0 !== x.length && f(x, h);
        0 !== s.length && f(s, - 1)
    })(a, b, d, h, c);
    return !0
};
JSM.ExportBodyContentToStl = function(a, b, c) {
    ...
    function f(b) {
        var d = a.GetPolygon(b), f = d.VertexIndexCount();
        if (!(3 > f)) {
            var g, n, p, q = null;
            if (3 === f)
                q = JSM.CalculateBodyPolygonNormal(a, b), g = a.GetVertex(d.GetVertexIndex(0)).position, n = a.GetVertex(d.GetVertexIndex(1)).position,
                p = a.GetVertex(d.GetVertexIndex(2)).position, e(q, g, n, p);
            else if (g=!0, void 0 !== c && c && (g=!1), q = JSM.CalculateBodyPolygonNormal(a, b), g) {
                g = new JSM.Polygon;
                for (b = 0; b < f; b++)
                    n = a.GetVertex(d.vertices[b]), g.AddVertex(n.position.x, n.position.y, n.position.z);
                f = JSM.PolygonTriangulate(g, q);
                for (b = 0; b < f.length; b++)
                    p = f[b], g = a.GetVertex(d.GetVertexIndex(p[0])).position, n = a.GetVertex(d.GetVertexIndex(p[1])).position, p = a.GetVertex(d.GetVertexIndex(p[2])).position, e(q, g, n, p)
                } else 
                    for (b = 0; b < f - 2; b++)
                        g = a.GetVertex(d.GetVertexIndex(0)).position,
                        n = a.GetVertex(d.GetVertexIndex((b + 1)%f)).position, p = a.GetVertex(d.GetVertexIndex((b + 2)%f)).position, e(q, g, n, p)
        }
    }
    var g = "";
    for (b = 0; b < a.PolygonCount(); b++)
...
JSM.ExportModelToStl = function(a, b, c) {
    ...
    for (e = 0; e < a.BodyCount(); e++)
        f = a.GetBody(e), d += JSM.ExportBodyContentToStl(f, b + (e + 1).toString(), c);
    return d + ("endsolid " + b + "\n")
};
...
JSM.ExportModelToObj = function(a) {
    var b = "", c = 0, d = 0, e, f;
    for (e = 0; e < a.BodyCount(); e++)
        f = a.GetBody(e), b += JSM.ExportBodyContentToObj(f, c, d), c += f.VertexCount(), d += f.PolygonCount();
    return b
};
...
JSM.ExportBodyGeometryToGdl = function(a, b) {
    ...
    function f(b) {
        var c = k.edges[b], e = 0;
        - 1 != c.pgon1&&-1 != c.pgon2 && a.GetPolygon(c.pgon1).HasCurveGroup() && a.GetPolygon(c.pgon2).HasCurveGroup() && a.GetPolygon(c.pgon1).GetCurveGroup() == a.GetPolygon(c.pgon2).GetCurveGroup() && (e = 2);
        d("edge " +
        (c.vert1 + 1) + ", " + (c.vert2 + 1) + ", -1, -1, " + e + " ! " + (b + 1))
    }
    function g(e, f) {
        var g =- 1;
        b && (g = a.GetPolygon(e).GetMaterialIndex() + 2, g != f && d('set material "material' + g + '"'));
        var h = k.pgons[e], l = 0;
        a.GetPolygon(e).HasCurveGroup() && (l = 2);
        c("pgon " + h.pedges.length + ", 0, " + l + ", ");
        var l = "", m, u;
        for (m = 0; m < h.pedges.length; m++)
            u = h.pedges[m], l = u.reverse ? l +- (u.index + 1) : l + (u.index + 1), m < h.pedges.length - 1 && (l += ", ");
        c(l);
        c(" ! " + (e + 1));
        d("");
        return g
    ...
    var h = "";
    d("base");
    var k = JSM.CalculateAdjacencyInfo(a), l;
...
JSM.ExportModelToGdl = function(a, b) {
    ...
    var e, f;
    for (e = 0; e < a.BodyCount(); e++)
        f = a.GetBody(e), c += JSM.ExportBodyGeometryToGdl(f, d);
    return c
};
...
JSM.TriangleBody.prototype.AddNormal = function(a, b, c) {
    this.normals.push(new JSM.Coord(a, b, c));
...
JSM.TriangleBody.prototype.Finalize = function(a) {
    function b(b, c, d, f) {
        function g(a, b, c, d, e) {
            var f = new JSM.Vector(0, 0, 0), h = 0;
            c = a.GetTriangle(c);
            b = e[b];
            var k, l;
            for (e = 0; e < b.length; e++)
                k = b[e], l = a.GetTriangle(k), c.curve == l.curve && (f = JSM.CoordAdd(f, d[k]), h += 1);
            f = JSM.VectorMultiply(f, 1 / h);
            f = JSM.VectorNormalize(f);
            return a.AddNormal(f.x, f.y, f.z)
        }
        var p = b.triangles[e];
        void 0 === p.mat && (p.mat = a.GetDefaultMaterialIndex());
        if (void 0 === p.n0 || void 0 === p.n1 || void 0 === p.n2)
            void 0 === p.curve || 0 === p.curve ? (c = d[e], c = b.AddNormal(c.x,
        c.y, c.z), p.n0 = c, p.n1 = c, p.n2 = c) : (p.n0 = g(b, p.v0, c, d, f), p.n1 = g(b, p.v1, c, d, f), p.n2 = g(b, p.v2, c, d, f));
        if (void 0 === p.u0 || void 0 === p.u1 || void 0 === p.u2)
            p.u0 = b.AddDefaultUV(), p.u1 = b.AddDefaultUV(), p.u2 = b.AddDefaultUV()
    }
    var c = [], d = {}, e;
    ...
    for (e = 0; e < this.triangles.length; e++)
        f = this.triangles[e], g = JSM.CalculateTriangleNormal(this.vertices[f.v0], this.vertices[f.v1], this.vertices[f.v2]), c.push(g), d[f.v0].push(e), d[f.v1].push(e), d[f.v2].push(e);
    for (e = 0; e < this.triangles.length; e++)
        b(this,
        e, c, d)
};
JSM.TriangleBody.prototype.Clone = function() {
    ...
    for (b = 0; b < this.triangles.length; b++)
        c = this.triangles[b], a.triangles.push({
            v0: c.v0,
            v1: c.v1,
            v2: c.v2,
            n0: c.n0,
...
JSM.TriangleModel.prototype.AddMaterial = function(a) {
    if (void 0 === a || null === a)
        a = {};
    var b = {};
    JSM.CopyObjectProperties(a, b, !0);
...
JSM.GetArrayBufferFromFile = function(a, b) {
    ...
    c.onloadend = function(a) {
        a.target.readyState == FileReader.DONE && b(a.target.result)
    };
...
JSM.LoadMultipleBuffersInternal = function(a, b, c, d) {
    if (b >= a.length)
        ...
        var e = a[b], f = null, f = e.isFile ? e.isArrayBuffer ? JSM.GetArrayBufferFromFile: JSM.GetStringBufferFromFile: e.isArrayBuffer ? JSM.GetArrayBufferFromURL: JSM.GetStringBufferFromURL;
        f(e.originalObject, function(e) {
            c.push(e);
            JSM.LoadMultipleBuffersInternal(a, b + 1, c, d)
        })
    }
};
JSM.LoadMultipleBuffers = function(a, b) {
    JSM.LoadMultipleBuffersInternal(a, 0, [], function(a) {
        b(a)
    })
};
JSM.ConvertTriangleModelToJsonData = function(a) {
    function b(a, b, c) {
        ...
        for (a = 0; a < b.VertexCount(); a++)
            f = b.GetVertex(a), c.vertices.push(f.x, f.y, f.z);
        for (a = 0; a < b.NormalCount(); a++)
            f = b.GetNormal(a), c.normals.push(f.x, f.y, f.z);
        for (a = 0; a < b.UVCount(); a++)
            f = b.GetUV(a), c.uvs.push(f.x, f.y);
        for (a = 0; a < e; a++)
            d.push([]);
        for (a = 0; a < b.TriangleCount(); a++)
            f = b.GetTriangle(a), void 0 === f.mat || (0 > f.mat || f.mat >= e) || d[f.mat].push(a);
        var p, q;
        for (a = 0; a < d.length; a++)
            if (p = d[a], 0 !== p.length) {
                ...
                for (e = 0; e < p.length; e++)
                    f = b.GetTriangle(p[e]), q.parameters.push(f.v0, f.v1, f.v2, f.n0, f.n1, f.n2, f.u0, f.u1, f.u2);
                    c.triangles.push(q)
            }
    }
    var c = {
    ...
    for (d = 0; d < a.BodyCount(); d++)
        e = a.GetBody(d), 0 !== e.TriangleCount() && (f = {
            name: e.GetName(),
            vertices: [],
            normals: [],
            uvs: [],
...
JSM.MergeJsonDataMeshes = function(a) {
    function b(a, b, c) {
        ...
        var e = a.vertices.length / 3, f = a.normals.length / 3, g = a.uvs.length / 2;
        (function(a,
        b) {
            var c;
        ...
        var t, r;
        for (t = 0; t < b.triangles.length; t++)
            r = b.triangles[t], d(a, r, c)
    }
    var c = {
        version: a.version,
    ...
    for (f = 0; f < a.meshes.length; f++)
        g = a.meshes[f], b(d, g, e);
    c.meshes.push(d);
    return c
};
JSM.Read3dsFile = function(a, b) {
    var c, d, e, f, g, h, k, l, m, n, p, q, t, r, v, u, s, x, z, y, w, A, B, L, N, F, C, D, J, O, M, H, G, I, K, P, T, S, U, Y;
    function E(a, c) {
    ...
    function Q(a, b, c) {
        for (; a.GetPosition() <= b - 6;) {
            var d = a, e = c, f = d.ReadUnsignedInteger16(), d = d.ReadUnsignedInteger32();
            e(f, d)
        }
    }
    if (void 0 ===
    ...
    (function(a) {
        function V(a, b, c) {
            ...
            var e=!1;
            Q(a, b, function(b, c) {
                b == p ? e || (d[0] = a.ReadUnsignedCharacter() / 255, d[1] = a.ReadUnsignedCharacter() / 255, d[2] = a.ReadUnsignedCharacter() /
                255) : b == q ? (d[0] = a.ReadUnsignedCharacter() / 255, d[1] = a.ReadUnsignedCharacter() / 255, d[2] = a.ReadUnsignedCharacter() / 255, e=!0) : b == n ? e || (d[0] = a.ReadFloat32(), d[1] = a.ReadFloat32(), d[2] = a.ReadFloat32()) : b == t ? (d[0] = a.ReadFloat32(), d[1] = a.ReadFloat32(), d[2] = a.ReadFloat32(), e=!0) : a.Skip(c - 6)
            });
            return d
        }
        function W(a, b, c) {
            ...
            b = a.GetPosition() + c - 6;
            Q(a, b, function(b, c) {
                b == w ? d = a.ReadUnsignedInteger16() / 100 : b == A ? d = a.ReadFloat32() : a.Skip(c - 6)
            });
            return d
        }
        function Z(a, b, c, d) {
            ...
            b = a.GetPosition() + c - 6;
            Q(a, b, function(b, c) {
                b == v ? d.texture = R(a) : b == u ? d.offset[0] = a.ReadFloat32() : b == s ? d.offset[1] = a.ReadFloat32() : b == x ? d.scale[0] = a.ReadFloat32() : b == z ? d.scale[1] = a.ReadFloat32() : b == y ? d.rotation = a.ReadFloat32() : a.Skip(c - 6)
            })
        }
        function $(a, c, d) {
            E("Read material chunk (" + c.toString(16) + ", " + d + ")", 2);
            var n = {}, p = a.GetPosition() + d - 6;
            Q(a, p, function(b, p) {
                b == e ? (E("Read material name chunk (" + c.toString(16) + ", " + d + ")", 3), n.name = R(a)) : b == f ? (E("Read material ambient chunk (" + c.toString(16) +
                ", " + d + ")", 3), n.ambient = V(a, b, p)) : b == g ? (E("Read material diffuse chunk (" + c.toString(16) + ", " + d + ")", 3), n.diffuse = V(a, b, p)) : b == h ? (E("Read material specular chunk (" + c.toString(16) + ", " + d + ")", 3), n.specular = V(a, b, p)) : b == k ? (E("Read material shininess chunk (" + c.toString(16) + ", " + d + ")", 3), n.shininess = W(a, b, p)) : b == l ? (E("Read material shininess strength chunk (" + c.toString(16) + ", " + d + ")", 3), n.shininessStrength = W(a, b, p)) : b == m ? (E("Read material transparency chunk (" + c.toString(16) + ", " + d + ")", 3), n.transparency =
                W(a, b, p)) : b == r ? (E("Read material texture map chunk (" + c.toString(16) + ", " + d + ")", 3), Z(a, b, p, n)) : (E("Skip chunk (" + b.toString(16) + ", " + p + ")", 3), a.Skip(p - 6))
            });
            if (void 0 !== b.onMaterial && null !== b.onMaterial)
                b.onMaterial(n)
        }
        function aa(a, c, d) {
            E("Read faces chunk (" + c.toString(16) + ", " + d + ")", 4);
            c = a.GetPosition() + d - 6;
            var e = a.ReadUnsignedInteger16(), f, g, h, k;
            for (d = 0; d < e; d++)
                if (f = a.ReadUnsignedInteger16(), g = a.ReadUnsignedInteger16(), h = a.ReadUnsignedInteger16(), k = a.ReadUnsignedInteger16(), void 0 !== b.onFace &&
                null !== b.onFace)
                    b.onFace(f, g, h, k);
            Q(a, c, function(c, d) {
                if (c == M) {
                    E("Read face materials chunk (" + c.toString(16) + ", " + d + ")", 5);
                    var f = R(a), g = a.ReadUnsignedInteger16(), h, k;
                    for (h = 0; h < g; h++)
                        if (k = a.ReadUnsignedInteger16(), void 0 !== b.onFaceMaterial && null !== b.onFaceMaterial)
                            b.onFaceMaterial(k, f)
                } else if (c == H) {
                    E("Read face smoothing groups chunk (" + c.toString(16) + ", " + d + ")", 5);
                    for (f = 0; f < e; f++)
                        if (g = a.ReadUnsignedInteger32(), void 0 !== b.onFaceSmoothingGroup && null !== b.onFaceSmoothingGroup)
                            b.onFaceSmoothingGroup(f,
                            g)
                } else 
                    E("Skip chunk (" + c.toString(16) + ", " + d + ")", 5), a.Skip(d - 6)
            })
        }
        function ba(a, c, d, e) {
            E("Read mesh chunk (" + c + ", " + d.toString(16) + ", " + e + ")", 3);
            if (void 0 !== b.onMesh && null !== b.onMesh)
                b.onMesh(c);
            c = a.GetPosition() + e - 6;
            Q(a, c, function(c, d) {
                if (c == C) {
                    E("Read vertices chunk (" + c.toString(16) + ", " + d + ")", 4);
                    var e = a.ReadUnsignedInteger16(), f, g, h, k;
                    for (f = 0; f < e; f++)
                        if (g = a.ReadFloat32(), h = a.ReadFloat32(), k = a.ReadFloat32(), void 0 !== b.onVertex && null !== b.onVertex)
                            b.onVertex(g, h, k)
                } else if (c == D) {
                    E("Read texture vertices chunk (" +
                    c.toString(16) + ", " + d + ")", 4);
                    e = a.ReadUnsignedInteger16();
                    for (f = 0; f < e; f++)
                        if (g = a.ReadFloat32(), h = a.ReadFloat32(), void 0 !== b.onTextureVertex && null !== b.onTextureVertex)
                            b.onTextureVertex(g, h)
                } else if (c == J)
                    aa(a, c, d);
                else if (c == O) {
                    E("Read transformation chunk (" + c.toString(16) + ", " + d + ")", 4);
                    e = [];
                    for (f = 0; 4 > f; f++) {
                        for (g = 0; 3 > g; g++)
                            e.push(a.ReadFloat32());
                        3 > f ? e.push(0) : e.push(1)
                    }
                    if (void 0 !== b.onTransformation && null !== b.onTransformation)
                        b.onTransformation(e)
                } else 
                    E("Skip chunk (" + c.toString(16) + ", " + d + ")", 4),
                    a.Skip(d - 6)
            })
        }
        function ca(a, b, c) {
            E("Read object chunk (" + b.toString(16) + ", " + c + ")", 2);
            b = a.GetPosition() + c - 6;
            var d = R(a);
            Q(a, b, function(b, c) {
                b == L ? ba(a, d, b, c) : (b == N ? E("Skip light chunk (" + d + ", " + b.toString(16) + ", " + c + ")", 3) : b == F ? E("Skip camera chunk (" + d + ", " + b.toString(16) + ", " + c + ")", 3) : E("Skip chunk (" + b.toString(16) + ", " + c + ")", 3), a.Skip(c - 6))
            })
        }
        function da(a, b, c) {
            E("Read editor chunk (" + b.toString(16) + ", " + c + ")", 1);
            b = a.GetPosition() + c - 6;
            Q(a, b, function(b, c) {
                b == d ? $(a, b, c) : b == B ? ca(a, b, c) : (E("Skip chunk (" +
                b.toString(16) + ", " + c + ")", 2), a.Skip(c - 6))
            })
        }
        function ea(a, c, d) {
            function e(a, b) {
                ...
                for (d = 0; d < h; d++)
                    a.ReadInteger32(), f = a.ReadUnsignedInteger16(), 0 !== f && a.ReadFloat32(), b == S ? (g = a.ReadFloat32(), f = X(a), f[3] = g) : f = X(a), c.push(f);
                return c
            }
            E("Read object node chunk (" + c.toString(16) + ", " + d + ")", 2);
            var f = {
                name: "",
                nodeId: - 1,
                flags: - 1,
            ...
            c = a.GetPosition() + d - 6;
            Q(a, c, function(b, c) {
                b == K ? (f.name = R(a), f.flags = a.ReadUnsignedInteger32(),
                f.userId = a.ReadUnsignedInteger16()) : b == P ? f.pivot = X(a) : b == T ? f.positions = e(a, T) : b == S ? f.rotations = e(a, S) : b == U ? f.scales = e(a, U) : b == Y ? f.nodeId = a.ReadUnsignedInteger16() : (E("Skip chunk (" + b.toString(16) + ", " + c + ")", 3), a.Skip(c - 6))
            });
            if (void 0 !== b.onObjectNode && null !== b.onObjectNode)
                b.onObjectNode(f)
        }
        function fa(a, b, c) {
            E("Read keyframe chunk (" + b.toString(16) + ", " + c + ")", 1);
            b = a.GetPosition() + c - 6;
            Q(a, b, function(b, c) {
                b == I ? ea(a, b, c) : (E("Skip chunk (" + b.toString(16) + ", " + c + ")", 2), a.Skip(c - 6))
            })
        }
        function ga(a, b,
        d) {
            E("Read main chunk (" + b.toString(16) + ", " + d + ")", 0);
            b = a.GetPosition() + d - 6;
            Q(a, b, function(b, d) {
                b == c ? da(a, b, d) : b == G ? fa(a, b, d) : (E("Skip chunk (" + b.toString(16) + ", " + d + ")", 1), a.Skip(d - 6))
            })
        }
        var ha = a.GetByteLength();
        Q(a, ha, function(b, c) {
            19789 == b ? ga(a, b, c) : (E("Skip chunk (" + b.toString(16) + ", " + c + ")", 0), a.Skip(c - 6))
        })
...
JSM.Convert3dsToJsonData = function(a, b) {
    ...
    if (void 0 === b || null === b)
        b = {};
    var d = new JSM.TriangleModel, e = null, f = {}, g = {}, h = {
        nodes: [],
        nodeIdToIndex: {}
    };
    JSM.Read3dsFile(a, {
    ...
    (function(a, b, c) {
        function d(a, b, c) {
            ...
            function g(a, b) {
                var c, d;
                for (c = 0; c < a.VertexCount(); c++)
                    d = a.GetVertex(c), d = JSM.ApplyTransformation(b, d), a.SetVertex(c, d.x, d.y, d.z)
            }
            function h(a, b, c) {
            ...
            function k(a, b) {
                ...
                if (0 === a.rotations.length)
                    ...
                    d = a.rotations[0];
                    var g = [0, 0, 0, 1], h = Math.sqrt(d[0] * d[0] + d[1] * d[1] + d[2] * d[2]);
        ...
        function e(a, b, c, f) {
            ...
            for (g = 0; g < a.TriangleCount(); g++)
                h = a.GetTriangle(g), b && (h.u0 = h.v0, h.u1 = h.v1, h.u2 = h.v2), k = f.faceToMaterial[g], void 0 !== k && (k = c[k], void 0 !== k && (h.mat = k)), k = f.faceToSmoothingGroup[g], void 0 !== k && (h.curve = k)
        }
        function f(a, b, c, d) {
            b = b.Clone();
        ...
        for (g = 0; g < b.BodyCount(); g++)
            if (v = b.GetBody(g), u = v.meshData, 0 === u.objectNodes.length)
                e(v, null, c, a);
            else {
                x = a.nodes[u.objectNodes[0]];
                for (h =
                1; h < u.objectNodes.length; h++)
                    s = a.nodes[u.objectNodes[h]], z = f(b, v, g + 1, h + 1), z.meshData = v.meshData, e(z, s, c, a), g += 1;
                    e(v, x, c, a)
            }
    })(h, d, f);
    d.Finalize();
                ...
                if ("g" == n[0]) {
                    if (!(2 > n.length)) {
                        ...
                        for (a = 1; a < n.length; a++)
                            p += n[a], a < n.length - 1 && (p += " ");
                            if (void 0 !== b.onMesh && null !== b.onMesh)
                                b.onMesh(p)
                            }
                } else if ("v" == n[0])
                    4 > n.length || d(parseFloat(n[1]), parseFloat(n[2]), parseFloat(n[3]));
                else if ("vn" == n[0])
                    4 > n.length || e(parseFloat(n[1]), parseFloat(n[2]), parseFloat(n[3]));
                else if ("vt" == n[0])
                    3 > n.length || f(parseFloat(n[1]),
                    parseFloat(n[2]));
                else if ("f" == n[0]) {
                    if (!(4 > n.length)) {
                        var p = [], q = [], t = [], r;
                        for (a = 1; a < n.length; a++)
                            r = n[a].split("/"), p.push(parseInt(r[0], 10) - 1), 1 < r.length && 0 < r[1].length && t.push(parseInt(r[1], 10) - 1), 2 < r.length && 0 < r[2].length && q.push(parseInt(r[2], 10) - 1);
                            if (void 0 !== b.onFace && null !== b.onFace)
                                b.onFace(p, q, t)
                            }
                } else if ("usemtl" == n[0]) {
                    if (!(2 > n.length) && void 0 !== b.onUseMaterial && null !== b.onUseMaterial)
                        b.onUseMaterial(n[1])
                } else if ("newmtl" == n[0]) {
                    if (!(2 > n.length) && void 0 !== b.onNewMaterial && null !== b.onNewMaterial)
                        b.onNewMaterial(n[1])
                } else if ("Ka" ==
                n[0] || "Kd" == n[0] || "Ks" == n[0])
                    4 > n.length || c(n[0], parseFloat(n[1]), parseFloat(n[2]), parseFloat(n[3]));
                else if ("Ns" == n[0] || "Tr" == n[0] || "d" == n[0]) {
                    if (!(2 > n.length) && void 0 !== b.onMaterialParameter && null !== b.onMaterialParameter)
                        b.onMaterialParameter(n[0], n[1])
                } else if ("map_Kd" == n[0]) {
                    if (!(2 > n.length) && (n = h(a, "map_Kd"), void 0 !== b.onMaterialTexture && null !== b.onMaterialTexture))
                        b.onMaterialTexture(n)
                } else 
                    "mtllib" == n[0]&&!(2 > n.length) && (n = h(a, "mtllib"), n = g(n.trim()), null !== n && k(n))
            }
        }
    function k(a) {
        a = a.split("\n");
...
JSM.ConvertObjToJsonData = function(a, b) {
    ...
    if (void 0 === b || null === b)
        b = {};
    var d = new JSM.TriangleModel, e = d.AddBody(new JSM.TriangleBody("Default")), f = d.GetBody(e), g = {}, h = null, k = null, l = [], m = [], n = [];
    JSM.ReadObjFile(a, {
        ...
        onMaterialComponent: function(a, b, c, d) {
            null !== h && ("Ka" == a ? h.ambient = [b, c, d] : "Kd" == a ? h.diffuse = [b, c, d] : "Ks" == a &&
            (h.specular = [b, c, d]))
        },
        onMaterialParameter: function(a, b) {
            if (null !== h)
                if ("Ns" == a)
                    h.shininess = 0, JSM.IsPositive(b) && (h.shininess = (Math.log2(parseFloat(b)) - 1) / 10);
                else if ("Tr" == a || "d" == a)
                    h.opacity = parseFloat(b)
        },
        ...
        onFace: function(a, b, c) {
            var d, e, g = b.length == a.length, h = c.length == a.length, l = a.length;
            for (d = 0; d < l - 2; d++)
                e = f.AddTriangle(a[0], a[(d + 1)%l], a[(d + 2)%l]), e = f.GetTriangle(e), g && (e.n0 = b[0], e.n1 = b[(d + 1)%l], e.n2 = b[(d + 2)%l]), h && (e.u0 = c[0], e.u1 = c[(d + 1)%l], e.u2 = c[(d + 2)%l]), null !== k && (e.mat = k)
        },
        onFileRequested: c
    });
    (function(a, b, c) {
        function d(a, b, c, e, f) {
            if (void 0 !== c) {
                ...
                if (void 0 !== g)
                    return g;
                b = b[c];
                0 === f ? g = a.AddVertex(b.x, b.y, b.z) : 1 === f ? g = a.AddNormal(b.x, b.y, b.z) : 2 === f && (g = a.AddUV(b.x, b.y));
                return e[c] = g
            }
        }
        var e, f, g, h, k, l, m;
        for (e = 0; e < a.BodyCount(); e++) {
            ...
            l = {};
            m = {};
            for (f = 0; f < g.TriangleCount(); f++)
                h = g.GetTriangle(f), h.v0 = d(g, b, h.v0, k, 0), h.v1 = d(g, b, h.v1, k, 0), h.v2 = d(g, b, h.v2, k, 0), h.n0 = d(g, c, h.n0, l, 1), h.n1 = d(g, c, h.n1, l, 1), h.n2 = d(g, c, h.n2, l, 1), h.u0 = d(g, n, h.u0, m, 2), h.u1 = d(g, n, h.u1, m, 2), h.u2 = d(g, n, h.u2, m, 2)
        }
    })(d, l, m, n);
    d.Finalize();
    return JSM.ConvertTriangleModelToJsonData(d)
...
JSM.ReadBinaryStlFile = function(a, b) {
    ...
    for (f = 0; f < e; f++)
        if (l = c(d), g = c(d), h = c(d), k = c(d), d.Skip(2), void 0 !== b.onFace && null !== b.onFace)
            b.onFace(g, h, k, l)
};
            ...
            for (l = c + 1; l < a.length && 3 > e.length; l++)
                if (m = a[l].trim(), 0 !== m.length && (m = m.split(/\s+/), 0 !== m.length && "vertex" == m[0]))
                    if (4 > m.length)
                        ...
                        m = [parseFloat(m[1]), parseFloat(m[2]), parseFloat(m[3])], e.push(m);
            l += 1;
            if (3 != e.length)
                return - 1;
            if (void 0 !== b.onFace && null !== b.onFace)
...
JSM.ConvertStlToJsonData = function(a, b) {
    var c = new JSM.TriangleModel, d = c.AddBody(new JSM.TriangleBody("Default")), e = c.GetBody(d);
    null !== a ? JSM.ReadBinaryStlFile(a, {
        onFace: function(a, b, c, d) {
            ...
            d = JSM.VectorNormalize(new JSM.Vector(d[0], d[1], d[2]));
...
JSM.ImportFileList = function() {
    this.isFile = this.descriptors = this.originalList = null
};
JSM.ImportFileList.prototype.InitFromFiles = function(a) {
    ...
    for (b = 0; b < a.length; b++)
        c = a[b], c = {
            ...
            extension: this.GetFileExtension(c.name)
...
JSM.ImportFileList.prototype.InitFromURLs = function(a) {
    ...
    var b, c, d;
    for (b = 0; b < a.length; b++)
        c = a[b], d = this.GetFileName(c), c = {
            originalObject: c,
            originalFileName: d,
            fileName: d.toUpperCase(),
            extension: this.GetFileExtension(d)
        }, this.descriptors.push(c);
    this.isFile=!1
};
...
JSM.ImportFileList.prototype.GetFileName = function(a) {
    ...
    return 0 === b.length ? "" : b[b.length - 1]
};
...
JSM.ImportFileList.prototype.GetMainFileIndex = function() {
    ...
    for (a = 0; a < this.descriptors.length; a++)
        if (b = this.descriptors[a], this.IsSupportedExtension(b.extension))
            return a;
    return - 1
};
JSM.ImportFileList.prototype.GetFileIndexByName = function(a) {
    var b, c, d;
    for (b = 0; b < this.descriptors.length; b++)
        if (c = this.descriptors[b], d = this.GetFileName(a), c.fileName == d.toUpperCase())
            return b;
    return - 1
};
    ...
    if ( - 1 === f)
        ...
        try {
            ...
            g.extension ? JSM.LoadMultipleBuffers(k, function(b) {
                var c = JSM.Convert3dsToJsonData(b[f], {
                ...
                var c = JSM.ConvertObjToJsonData(b[f], {
                    onFileRequested: function(c) {
                        return e(a, b, c, h)
                    }
                });
                ...
                a = a[f];
                if (JSM.IsBinaryStlFile(a))
                    a = JSM.ConvertStlToJsonData(a, null), d(h, a);
                else {
                    for (a = 0; a < k.length; a++)
                        k[a].isArrayBuffer=!1;
                    JSM.LoadMultipleBuffers(k,
                    function(a) {
                        a = JSM.ConvertStlToJsonData(null, a[f]);
                        d(h, a)
                    })
                }
            })
...
JSM.GenerateSolidWithRadius = function(a, b) {
    ...
    if (0 < c.VertexCount()) {
        var e = 0;
        if (d)
            e = JSM.VectorLength(c.GetVertexPosition(0));
        else 
            for (var f, d = 0; d < c.VertexCount(); d++)
                f = JSM.VectorLength(c.GetVertexPosition(d)), JSM.IsGreater(f, e) && (e = f);
        e = b / e;
        for (d = 0; d < c.VertexCount(); d++)
            f = c.GetVertex(d), f.SetPosition(JSM.VectorMultiply(f.GetPosition(),
            e))
    }
    return c
};
...
JSM.GenerateDodecahedron = function() {
    var a = new JSM.Body, b = (1 + Math.sqrt(5)) / 2, c = 1 / b;
    JSM.AddVertexToBody(a, 1, 1, 1);
    JSM.AddVertexToBody(a, 1, 1, - 1);
    JSM.AddVertexToBody(a, 1, - 1, 1);
    JSM.AddVertexToBody(a, - 1, 1, 1);
...
JSM.GenerateIcosahedron = function() {
    var a = new JSM.Body, b = (1 + Math.sqrt(5)) / 2;
...
JSM.GenerateTruncatedCube = function() {
    var a = new JSM.Body, b = Math.sqrt(2) - 1;
...
JSM.GenerateRhombicuboctahedron = function() {
    var a = new JSM.Body, b = 1 + Math.sqrt(2);
    JSM.AddVertexToBody(a, 1, 1, + b);
    JSM.AddVertexToBody(a, 1, 1, - b);
    JSM.AddVertexToBody(a, 1, - 1, + b);
    JSM.AddVertexToBody(a, - 1, 1, + b);
...
JSM.GenerateTruncatedCuboctahedron = function() {
    var a = new JSM.Body, b = 1 + Math.sqrt(2), c = 1 + 2 * Math.sqrt(2);
...
JSM.GenerateSnubCube = function() {
    var a = new JSM.Body, b = 1 / 3 * (Math.pow(17 + 3 * Math.sqrt(33), 1 / 3) - Math.pow( - 17 + 3 * Math.sqrt(33), 1 / 3) - 1), c = 1 / b;
    JSM.AddVertexToBody(a, 1, + b, - c);
    JSM.AddVertexToBody(a, 1, - b, + c);
    JSM.AddVertexToBody(a, - 1, + b, + c);
    JSM.AddVertexToBody(a, - 1, - b, - c);
...
JSM.GenerateIcosidodecahedron = function() {
    var a = new JSM.Body, b = (1 + Math.sqrt(5)) / 2, c = b / 2, d = (1 + b) / 2;
...
JSM.GenerateTruncatedDodecahedron = function() {
    var a = new JSM.Body, b = (1 + Math.sqrt(5)) / 2, c = 1 / b, d = 2 + b, e = 2 * b, f = Math.pow(b, 2);
...
JSM.GenerateTruncatedIcosahedron = function() {
    var a = new JSM.Body, b = (1 + Math.sqrt(5)) / 2, c = 3 * b, d = 1 + 2 * b, e = 2 + b, f = 2 * b;
...
JSM.GenerateRhombicosidodecahedron = function() {
    var a = new JSM.Body, b = (1 + Math.sqrt(5)) / 2, c = Math.pow(b, 2), d = Math.pow(b, 3), e = 2 * b, f = 2 + b;
...
JSM.GenerateTruncatedIcosidodecahedron = function() {
    var a = new JSM.Body, b = (1 + Math.sqrt(5)) / 2, c = 1 / b, d = 3 + b, e = 2 / b, f = 1 + 2 * b, g = Math.pow(b, 2), h =- 1 + 3 * b, k =- 1 + 2 * b, l = 2 + b, m = 2 * b;
...
JSM.GenerateSnubDodecahedron = function() {
    var a = new JSM.Body, b = (1 + Math.sqrt(5)) / 2, c = Math.pow(b / 2 + 0.5 * Math.sqrt(b - 5 / 27), 1 / 3) + Math.pow(b / 2 - 0.5 * Math.sqrt(b - 5 / 27), 1 / 3), d = c - 1 / c, e = c * b + Math.pow(b, 2) + b / c, c = 2 * d, f = 2 * e, g = d + e / b + b, h =- (d * b) + e + 1 / b, k = d / b + e * b - 1, l =- (d / b) + e * b + 1, m =- d + e / b - b, n = d * b + e - 1 / b, p =- (d / b) + e * b - 1, q = d - e / b - b, t = d * b + e + 1 / b, r = d + e / b - b, v = d * b - e + 1 / b, b = d / b + e * b + 1;
    ...
    JSM.AddVertexToBody(a,
    + p, + q, - t);
    JSM.AddVertexToBody(a, + p, - q, + t);
    JSM.AddVertexToBody(a, - p, + q, + t);
    JSM.AddVertexToBody(a, - p, - q, - t);
    JSM.AddVertexToBody(a, + q, - t, + p);
    JSM.AddVertexToBody(a, - q, + t, + p);
    JSM.AddVertexToBody(a, + q, + t, - p);
    JSM.AddVertexToBody(a, - q, - t, - p);
    JSM.AddVertexToBody(a, - t, + p, + q);
    JSM.AddVertexToBody(a, + t, + p, - q);
    JSM.AddVertexToBody(a, + t, - p, + q);
    JSM.AddVertexToBody(a, - t, - p, - q);
    JSM.AddVertexToBody(a, + r, + v, - b);
    JSM.AddVertexToBody(a, + r, - v, + b);
    JSM.AddVertexToBody(a, - r, + v, + b);
    JSM.AddVertexToBody(a, - r, - v, - b);
    JSM.AddVertexToBody(a,
    + v, - b, + r);
    JSM.AddVertexToBody(a, - v, + b, + r);
    JSM.AddVertexToBody(a, + v, + b, - r);
    JSM.AddVertexToBody(a, - v, - b, - r);
    JSM.AddVertexToBody(a, - b, + r, + v);
    JSM.AddVertexToBody(a, + b, + r, - v);
    JSM.AddVertexToBody(a, + b, - r, + v);
    JSM.AddVertexToBody(a, - b, - r, - v);
...
JSM.AddCumulatedPolygonToBody = function(a, b, c) {
    var d = new JSM.Coord(0, 0, 0), e = new JSM.Vector(0, 0, 0), f = d, g = [], h;
    for (h = 0; h < b.length; h++)
        g.push(a.GetVertexPosition(b[h]));
    h = JSM.CalculateCentroid(g);
    g = JSM.CalculateNormal(g);
    f.Set(h.x, h.y, h.z);
    e.Set(g.x, g.y, g.z);
    d = JSM.CoordOffset(d, e, c);
    c = a.VertexCount();
    JSM.AddVertexToBody(a, d.x, d.y, d.z);
    d = b.length;
    for (e = 0; e < d; e++)
        f = b[e], g = b[e < d - 1 ? e + 1: 0], JSM.AddPolygonToBody(a, [f, g, c])
};
...
JSM.GenerateCumulatedDodecahedron = function(a) {
    var b = new JSM.Body, c = (1 + Math.sqrt(5)) / 2, d = 1 / c;
    JSM.AddVertexToBody(b, 1, 1, 1);
    JSM.AddVertexToBody(b, 1, 1, - 1);
    JSM.AddVertexToBody(b, 1, - 1, 1);
    JSM.AddVertexToBody(b, - 1, 1, 1);
...
JSM.GenerateCumulatedIcosahedron = function(a) {
    var b = new JSM.Body, c = (1 + Math.sqrt(5)) / 2;
...
JSM.GenerateLegoBrick = function(a, b, c, d, e, f, g) {
    function h(a, b) {
        var c, d;
        for (c = 0; c < a.VertexCount(); c++)
            d = a.GetVertex(c), d.position = JSM.CoordAdd(d.position, b)
    }
    var k = new JSM.LegoDimensions, l = new JSM.Vector(0, 0, 1), m = k.legoWidth, n = k.legoLargeHeight;
    c || (n = k.legoSmallHeight);
    c = k.legoWallWidth;
    var p = k.legoCylinderWidth, q = k.legoCylinderHeight, t = k.legoBottomSmallCylinderWidth, r = k.legoBottomLargeCylinderWidth, v = k.legoBottomLargeCylinderWallWidth, u = [];
    u.push(new JSM.Coord(0, 0, 0));
    u.push(new JSM.Coord(m * a, 0, 0));
    u.push(new JSM.Coord(m * a, m * b, 0));
    u.push(new JSM.Coord(0, m * b, 0));
    var k = new JSM.Body, s = JSM.GeneratePrismShell(u, l, n - c, c, !0);
    k.Merge(s);
    for (s = 0; 4 > s; s++)
        u[s].z = n - c;
    s = JSM.GeneratePrism(u, l, c, !0);
    k.Merge(s);
    if (d)
        for (s = 0; s < a; s++)
            for (u = 0; u < b; u++)
                d = new JSM.Coord(m * s + m / 2, m * u + m / 2, n + q / 2), l = JSM.GenerateCylinder(p / 2, q, f, !0, g), h(l, d), k.Merge(l);
    if (e)
        if (1 === a && 1 < b || 1 === b && 1 < a) {
            e = b;
            p=!0;
            a > b && (e = a, p=!1);
            for (s = 0; s < e - 1; s++)
                d = p ? new JSM.Coord(m / 2, m * (s + 1), (n - c) / 2) : new JSM.Coord(m * (s + 1), m / 2, (n - c) / 2), l = JSM.GenerateCylinder(t /
                2, n - c, f, !0, g), h(l, d), k.Merge(l)
        } else if (1 < a && 1 < b)
            for (s = 0; s < a - 1; s++)
                for (u = 0; u < b - 1; u++)
                    d = new JSM.Coord(m * (s + 1), m * (u + 1), (n - c) / 2), l = JSM.GenerateCylinderShell(r / 2, n - c, v, f, !0, g), h(l, d), k.Merge(l);
...
JSM.GenerateConvexHullBody = function(a) {
    ...
    for (e = 0; e < c.length; e++) {
        g = c[e];
        for (f = 0; f < g.length; f++)
            h = g[f], h in d || (d[h] = b.VertexCount(), b.AddVertex(new JSM.BodyVertex(a[h])))
    }
    for (e = 0; e < c.length; e++) {
        g = c[e];
        a = [];
...
JSM.GenerateSuperShape = function(a, b, c, d, e, f, g, h, k, l, m, n, p, q) {
    function t(a) {
        var b = Math.sqrt(a.x * a.x + a.y * a.y + a.z * a.z), c = Math.asin(a.z / b);
    ...
    function v(p, q) {
        var v = new JSM.Coord(0, 0, 0), s = r(p, g, h, k, l, m, n), u = r(q, a, b, c, d, e, f);
        v.x = u * Math.cos(q) * s * Math.cos(p);
        v.y = u * Math.sin(q) * s * Math.cos(p);
        v.z = s * Math.sin(p);
        return v
    }
    p = JSM.GenerateSphere(1,
    p, q);
    var u, s;
    for (q = 0; q < p.VertexCount(); q++)
        u = p.GetVertex(q), s = u.position, s = t(s), s = v(s[1], s[2]), u.SetPosition(s);
    return p
};
JSM.OrderPolygons = function(a, b, c) {
    var d = [], e = [], f = [], g = [], h = [], k = [], l = [], m = a.PolygonCount(), n, p;
    for (n = 0; n < m; n++) {
        k.push(n);
        l.push([]);
        for (p = 0; p < m; p++)
        ...
        var k = JSM.VectorNormalize(JSM.CoordSub(c, b)), k = JSM.GetPlaneFromCoordAndDirection(b, k), l, m, n, p, s, x;
        for (l = 0; l < a.PolygonCount(); l++) {
            s = JSM.Inf;
            x =- JSM.Inf;
            n = a.GetPolygon(l);
            for (m = 0; m < n.VertexIndexCount(); m++)
                p = a.GetVertexPosition(n.GetVertexIndex(m)), p = JSM.CoordPlaneDistance(p, k), JSM.IsLower(p, s) && (s = p), JSM.IsGreater(p, x) && (x =
                p);
            d.push(s);
            e.push(x);
            m = a.GetPolygon(l);
            ...
            x = s = void 0;
            for (s = 0; s < m.VertexIndexCount(); s++)
                x = a.GetVertexPosition(m.GetVertexIndex(s)), n = JSM.CoordAdd(n, x);
            m = n = JSM.VectorMultiply(n, 1 / m.VertexIndexCount());
            n = JSM.CoordPlaneDistance(m, k);
            f.push(m);
            g.push(n);
            n = JSM.CalculateBodyPolygonNormal(a, l);
            s = JSM.VectorNormalize(JSM.CoordSub(m, b));
            s = JSM.VectorDot(n, s);
            JSM.IsGreaterOrEqual(s, 0) && (n = JSM.VectorMultiply(n, - 1));
            ...
            for (f = 0; f < b - c - 1; f++) {
                ...
                if (null !== l[g][m])
                    ...
                    if (n = JSM.IsLowerOrEqual(d[g], e[m])) {
                        var p = m;
                        n = h[g];
                        for (var z = h[p], y = void 0, w = void 0, A=!0, B = a.GetPolygon(g), y = 0; y < B.VertexIndexCount();
                        y++)if (w = a.GetVertexPosition(B.GetVertexIndex(y)),
                        "CoordInFrontOfPlane" === JSM.CoordPlanePosition(w, z)) {
                            A=!1;
                            break
                        }
                        if (A)
                            ...
                            z=!0;
                            p = a.GetPolygon(p);
                            for (y = 0; y < p.VertexIndexCount(); y++)
                                if (w = a.GetVertexPosition(p.GetVertexIndex(y)), "CoordAtBackOfPlane" === JSM.CoordPlanePosition(w, n)) {
                                    z=!1;
                                    break
                                }
                                n = z?!1 : !0
...
JSM.CanvasDrawer.prototype.DrawPolygon = function(a, b, c) {
    ...
    this.context.beginPath();
    for (d = 0; d < a.VertexCount(); d++)
        b = a.GetVertex(d), 0 === d ? this.context.moveTo(b.x, this.canvas.height - b.y) : this.context.lineTo(b.x, this.canvas.height - b.y);
    this.context.closePath();
    this.context.fill();
    if (c)
        for (d = 0; d < a.VertexCount(); d++)
            b = a.GetVertex(d), c = a.GetVertex(d < a.VertexCount() - 1 ? d + 1 : 0), this.DrawLine(b, c)
};
...
JSM.SVGDrawer.prototype.DrawLine = function(a, b) {
    var c = document.createElementNS(this.svgNameSpace, "line"), d = this.GetHeight();
...
JSM.SVGDrawer.prototype.DrawPolygon = function(a, b) {
    ...
    for (e = 0; e < a.VertexCount(); e++)
        f = a.GetVertex(e), c = c + f.x + ", " + (d - f.y), e < a.VertexCount() - 1 && (c += ", ");
...
JSM.DrawProjectedBody = function(a, b, c, d, e, f) {
    function g(a, b) {
        var c = JSM.Project(b, l, m, n, p * JSM.DegRad, q, t, r, v);
        a.AddVertex(c.x, c.y)
    }
    function h(b) {
        var c = new JSM.Polygon2D, d, e;
        for (d = 0; d < b.VertexIndexCount(); d++)
            e = a.GetVertexPosition(b.GetVertexIndex(d)), g(c, e);
        return c
    }
    e && f.Clear();
    e = f.GetWidth();
    var k = f.GetHeight(), l = c.eye, m = c.center, n = c.up, p = c.fieldOfView, q = e / k, t = c.nearClippingPlane, r = c.farClippingPlane, v = [0, 0, e, k], u, s, x, z;
    if ("HiddenLinePainter" == d) {
        ...
        for (c = 0; c < d.length; c++)
            u = a.GetPolygon(d[c]), s = h(u), x = u.GetMaterialIndex(), z = b.GetMaterial(x).diffuse, f.DrawPolygon(s, z, !0)
        ...
        JSM.TraverseBSPTreeForEyePosition(d, c.eye, function(c) {
            ...
            for (h = 0; h < d.VertexCount(); h++)
                k = d.GetVertex(h), g(e, k);
            s = e;
            u = a.GetPolygon(c.userData.originalPolygon);
            x = u.GetMaterialIndex();
            z = b.GetMaterial(x).diffuse;
            f.DrawPolygon(s, z, !0)
        })
        ...
        if (void 0 === b || null === b)
            b = new JSM.Materials;
        for (c = 0; c < a.PolygonCount(); c++)
            u = a.GetPolygon(c), s = h(u), "CounterClockwise" == JSM.PolygonOrientation2D(s) && (x = u.GetMaterialIndex(), z = b.GetMaterial(x).diffuse, f.DrawPolygon(s, z, !0))
    } else if ("Wireframe" == d) {
        var y, w, A, B = [];
        for (c = 0; c < a.PolygonCount(); c++) {
            w = y = null;
            ...
            for (d = 0; d <= k; d++)
                A = u.GetVertexIndex(d%k), e = a.GetVertexPosition(A), s = JSM.Project(e, l, m, n, p * JSM.DegRad,
                q, t, r, v), null !== y && (null !== w && void 0 === B[[w, A]]) && (f.DrawLine(y, s), B[[w, A]]=!0, B[[A, w]]=!0), w = A, y = s
        }
    }
    return !0
};
JSM.CatmullClarkSubdivisionOneIteration = function(a) {
    var b = new JSM.Body, c = JSM.CalculateAdjacencyInfo(a);
    (function() {
        var d, e;
        for (d = 0; d < c.verts.length; d++)
            e = a.GetVertex(d).position, b.AddVertex(new JSM.BodyVertex(new JSM.Coord(e.x, e.y, e.z)))
    })();
    var d = [];
    (function() {
        var e, g, h, k, l;
        for (e = 0; e < c.pgons.length; e++) {
            ...
            for (g = 0; g < h.verts.length; g++)
                k = a.GetVertex(h.verts[g]).position, l = JSM.CoordAdd(l, k);
            l = JSM.VectorMultiply(l, 1 / h.verts.length);
            d.push(b.AddVertex(new JSM.BodyVertex(l)))
        }
    })();
    var e = [];
    (function() {
        var f, g, h, k, l;
        for (f = 0; f < c.edges.length; f++) {
            h = c.edges[f];
            k = new JSM.Coord(0, 0, 0);
            k = JSM.CoordAdd(k, JSM.VectorMultiply(a.GetVertex(h.vert1).position, 0.25));
            k = JSM.CoordAdd(k, JSM.VectorMultiply(a.GetVertex(h.vert2).position, 0.25));
            for (g = 0; 2 > g; g++)
                l = 0 === g ? h.pgon1 : h.pgon2, - 1 === l && (l = 0 === g ? h.pgon2 : h.pgon1), l = b.GetVertex(d[l]).position, k = JSM.CoordAdd(k, JSM.VectorMultiply(l, 0.25));
            e.push(b.AddVertex(new JSM.BodyVertex(k)))
        }
    })();
    (function() {
        var e = [], g, h, k, l;
        for (k = 0; k < c.edges.length; k++)
            g =
            c.edges[k], h = JSM.MidCoord(a.GetVertex(g.vert1).position, a.GetVertex(g.vert2).position), e.push(h);
        var m, n, p;
        for (k = 0; k < c.verts.length; k++) {
            ...
            g = new JSM.Coord(0, 0, 0);
            n = 1 / m.pgons.length;
            for (l = 0; l < m.pgons.length; l++)
                h = b.GetVertex(d[m.pgons[l]]).position, p = JSM.CoordAdd(p, JSM.VectorMultiply(h, n));
            n = 1 / m.edges.length;
            for (l = 0; l < m.edges.length; l++)
                h = e[m.edges[l]], g = JSM.CoordAdd(g, JSM.VectorMultiply(h, n));
            m = m.edges.length;
            l = b.GetVertex(k).position;
            l.x = (p.x + 2 * g.x + (m - 3) * l.x) / m;
            l.y = (p.y + 2 * g.y + (m - 3) * l.y) / m;
            l.z = (p.z + 2 * g.z + (m - 3) * l.z) / m
        }
    })();
    (function() {
        var f, g, h, k, l, m, n, p;
        for (m = 0; m < c.pgons.length; m++) {
            p = c.pgons[m];
            f = p.verts.length;
            for (n = 0; n < f; n++)
                g = p.pedges[n], h = p.pedges[(n + 1)%f], k = d[m], g = e[g.index], l = JSM.GetPolyEdgeStartVertex(h, c), h = e[h.index], k = new JSM.BodyPolygon([k, g, l, h]), h = a.GetPolygon(m), k.material = h.material, k.curved = h.curved, b.AddPolygon(k)
        }
    })();
    return b
};
...
JSM.SvgToModel = function(a, b, c) {
    function d(a, b) {
        function c(a, b, d, e, f, g) {
            a = a.createSVGPoint();
            a.x = f;
            a.y = g;
            e = a.matrixTransform(e.getCTM());
            a = new JSM.Coord2D(e.x, e.y);
            f = new JSM.Coord2D(f, g);
            g = b.VertexCount(d);
            if (0 < g && JSM.CoordIsEqual2DWithEps(b.GetVertex(d, g - 1), a, 0.1))
                return f;
            b.AddVertex(d, e.x, e.y);
            return f
        }
        function d(a, b, e, f, g, h, k) {
            var l = document.createElementNS("http://www.w3.org/2000/svg", "path"), m = "M " + f.x + " " + f.y + " ", n, q, s, r, v;
            for (n = 0; n < g.length; n++)
                if (q = g[n], q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS ||
                q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_REL)
                    s = q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS ? "C" : "c", m += s + " " + q.x1 + " " + q.y1 + " " + q.x2 + " " + q.y2 + " " + q.x + " " + q.y + " ";
                else if (q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_ABS || q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_REL)
                    s = q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_ABS ? "Q" : "q", m += s + " " + q.x1 + " " + q.y1 + " " + q.x + " " + q.y + " ";
                else if (q.pathSegType == SVGPathSeg.PATHSEG_ARC_ABS || q.pathSegType == SVGPathSeg.PATHSEG_ARC_REL)
                    s = q.pathSegType ==
                    SVGPathSeg.PATHSEG_ARC_ABS ? "A" : "a", r = q.largeArcFlag ? 1 : 0, v = q.sweepFlag ? 1 : 0, m += s + " " + q.r1 + " " + q.r2 + " " + q.angle + " " + r + " " + v + " " + q.x + " " + q.y + " ";
                else if (q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_ABS || q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL)
                    s = q.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_ABS ? "S" : "s", m += s + " " + q.x2 + " " + q.y2 + " " + q.x + " " + q.y + " ";
            l.setAttributeNS(null, "d", m);
            m = l.getTotalLength();
            g = 0;
            0 < e && (g = parseInt(m / e, 10));
            3 > g && (g = 3);
            e = m / g;
            for (m = 1; m <= g; m++)
                f = l.getPointAtLength(m *
                e), f = c(a, h, k, b, f.x, f.y);
            return f
        }
        function e(a, b) {
            var c = a.VertexCount(b);
            if (0 !== c) {
                var d = a.GetVertex(b, 0), c = a.GetVertex(b, c - 1);
                JSM.CoordIsEqual2DWithEps(d, c, 0.1) && a.GetContour(b).vertices.pop()
            }
        }
        function f(a, b) {
            return 0 < a.VertexCount(b) ? (e(a, b), a.AddContour(), b + 1) : b
        }
        var g = new JSM.ContourPolygon2D, h = document.createElementNS("http://www.w3.org/2000/svg", "svg"), k;
        if (a instanceof SVGPathElement) {
            var l = new JSM.Coord2D(0, 0), z = new JSM.Coord2D(0, 0), y = b;
            a.hasAttribute("segmentlength") && (y = parseFloat(a.getAttribute("segmentlength")));
            var w, A, B = 0;
            for (k = 0; k < a.pathSegList.numberOfItems; k++)
                if (w = a.pathSegList.getItem(k), w.pathSegType != SVGPathSeg.PATHSEG_CLOSEPATH)
                    if (w.pathSegType == SVGPathSeg.PATHSEG_MOVETO_ABS)
                        B = f(g, B), l = c(h, g, B, a, w.x, w.y), z = l.Clone();
                    else if (w.pathSegType == SVGPathSeg.PATHSEG_MOVETO_REL)
                        B = f(g, B), l = c(h, g, B, a, z.x + w.x, z.y + w.y), z = l.Clone();
                    else if (w.pathSegType == SVGPathSeg.PATHSEG_LINETO_ABS)
                        l = c(h, g, B, a, w.x, w.y);
                    else if (w.pathSegType == SVGPathSeg.PATHSEG_LINETO_REL)
                        l = c(h, g, B, a, l.x + w.x, l.y + w.y);
                    else if (w.pathSegType == SVGPathSeg.PATHSEG_LINETO_HORIZONTAL_ABS)
                        l =
                        c(h, g, B, a, w.x, l.y);
                    else if (w.pathSegType == SVGPathSeg.PATHSEG_LINETO_VERTICAL_ABS)
                        l = c(h, g, B, a, l.x, w.y);
                    else if (w.pathSegType == SVGPathSeg.PATHSEG_LINETO_HORIZONTAL_REL)
                        l = c(h, g, B, a, l.x + w.x, l.y);
                    else if (w.pathSegType == SVGPathSeg.PATHSEG_LINETO_VERTICAL_REL)
                        l = c(h, g, B, a, l.x, l.y + w.y);
                    else if (w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS || w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_REL || w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_ABS || w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_REL ||
                    w.pathSegType == SVGPathSeg.PATHSEG_ARC_ABS || w.pathSegType == SVGPathSeg.PATHSEG_ARC_REL || w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_ABS || w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL) {
                        A = [];
                        if (w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_ABS || w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL) {
                            for (; k < a.pathSegList.numberOfItems; k++) {
                                w = a.pathSegList.getItem(k);
                                if (!(w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_ABS || w.pathSegType == SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL))
                                    break;
                                    A.push(w)
                                }
            ...
            c(h, g, 0, a, a.x.baseVal.value, a.y.baseVal.value), c(h, g, 0, a, a.x.baseVal.value + a.width.baseVal.value, a.y.baseVal.value), c(h, g, 0, a, a.x.baseVal.value + a.width.baseVal.value, a.y.baseVal.value + a.height.baseVal.value), c(h, g, 0, a, a.x.baseVal.value, a.y.baseVal.value + a.height.baseVal.value);
        else if (a instanceof SVGPolygonElement)
            for (k = 0; k < a.points.numberOfItems; k++)
                l = a.points.getItem(k), c(h, g, 0, a, l.x, l.y);
        g.color = function(a) {
            for (var b =
            ""; null !== a && void 0 !== a && 0 === b.length;)
                b = a.getAttribute("fill"), null === b && (b = a.style.fill), a = a.parentElement;
            a = 0;
            if (0 === b.length)
                return a;
            if ("#" == b[0])
                a = JSM.HexColorToRGBColor(b.substring(1));
            else {
    ...
    function e(a, b) {
        function c(a, b) {
            ...
            if ("Clockwise" == b)
                for (e = 0; e < a.VertexCount(); e++)
                    f = a.GetVertex(e),
                    d.push(new JSM.Coord(f.x, 0, - f.y));
            else 
                for (e = a.VertexCount() - 1; 0 <= e; e--)
                    f = a.GetVertex(e), d.push(new JSM.Coord(f.x, 0, - f.y));
            return d
        }
        function d(a, b, c) {
            a.push(null);
            ...
            if ("CounterClockwise" == c)
                for (c = 0; c < b.VertexCount(); c++)
                    e = b.GetVertex(c), a.push(new JSM.Coord(e.x, 0, - e.y));
            else 
                for (c = b.VertexCount() - 1; 0 <= c; c--)
                    e = b.GetVertex(c), a.push(new JSM.Coord(e.x, 0, - e.y))
        }
        var e = [], f = new JSM.Vector(0, - 1, 0), g = b;
        void 0 !== a.originalElem && a.originalElem.hasAttribute("modelheight") && (g = parseFloat(a.originalElem.getAttribute("modelheight")));
        var h, k;
        k = a.ContourCount();
        if (1 == k)
            k = JSM.PolygonOrientation2D(a.GetContour(0)), h = c(a.GetContour(0), k), h = JSM.GeneratePrism(h, f, g, !0), e.push(h);
        else if (1 < k) {
            k = JSM.PolygonOrientation2D(a.GetContour(0));
            var l = c(a.GetContour(0), k), z=!1, y;
            for (y = 1; y < a.ContourCount(); y++)
                h = JSM.PolygonOrientation2D(a.GetContour(y)), h == k ? (h = c(a.GetContour(y), k), h = JSM.GeneratePrism(h, f, g, !0), e.push(h)) : (d(l, a.GetContour(y), h), z=!0);
            h = z ? JSM.GeneratePrismWithHole(l, f, g, !0) : JSM.GeneratePrism(l, f, g, !0);
            e.push(h)
        }
        f = new JSM.Material({
            ambient: a.color,
    ...
    var f = new JSM.Model, g = new JSM.Materials;
    c = function(a, b) {
        function c(a, b, d) {
        ...
        c(a, "polygon", f);
        var g = b;
        a.hasAttribute("segmentlength") && (g = parseFloat(a.getAttribute("segmentlength")));
        var h, k;
        for (h = 0; h < f.length; h++)
            k = d(f[h], g), e.push(k);
        return e
    }(a, c);
    a.hasAttribute("modelheight") && (b = parseFloat(a.getAttribute("modelheight")));
    var h, k, l;
    for (a = 0; a < c.length; a++) {
        ...
        g.AddMaterial(h);
        for (h = 0; h < k.length; h++)
            l = k[h], l.SetPolygonsMaterialIndex(g.Count() - 1), f.AddBody(l)
    }
    return [f, g]
};
JSM.BooleanOperation = function(a, b, c) {
    function d(a, b, c, d) {
        ...
        if (d)
            for (d = a.VertexCount() - 1; 0 <= d; d--)
                g = e(a.GetVertex(d), c), f.AddVertexIndex(g);
        else 
            for (d = 0; d < a.VertexCount(); d++)
                g = e(a.GetVertex(d), c), f.AddVertexIndex(g);
    ...
    function f(a, b, c, d, e, f) {
        ...
        var h, k;
        for (h = 0; h < a.length; h++)
            k = a[h], JSM.ClipPolygonWithBSPTree(k.polygon, b, c, d, e, f), g(c, k.userData), g(d, k.userData), g(e, k.userData), g(f, k.userData)
    }
    var g = new JSM.BSPTree, h = new JSM.BSPTree;
    JSM.AddBodyToBSPTree(b, g, "a");
    JSM.AddBodyToBSPTree(c, h, "b");
    var k = [], l = [], m = [], n = [];
    f(g.GetNodes(), h, k, l, m, n);
    var p = [], q = [], t = [];
    f(h.GetNodes(), g, p, q, t, []);
    g = new JSM.Body;
    b = new JSM.Octree(JSM.BoxUnion(b.GetBoundingBox(), c.GetBoundingBox()));
    "Union" == a ? (e(k, g, b, !1), e(m, g, b, !1), e(n, g, b, !1), e(p, g, b, !1), e(t, g, b,
    !1)) : "Difference" == a ? (e(k, g, b, !1), e(m, g, b, !1), e(q, g, b, !0)) : "Intersection" == a && (e(l, g, b, !1), e(n, g, b, !1), e(q, g, b, !1));
    return g
};
...
JSM.GenerateBezierCurve = function(a, b) {
    ...
    for (f = 0; f <= b; f++) {
        ...
        for (g = 0; g <= d; g++)
            k = a[g], l = JSM.BernsteinPolynomial(g, d, h), m.x += k.x * l, m.y += k.y * l;
        c.push(m)
    }
    return c
};
JSM.GenerateSurface = function(a, b, c, d, e, f, g, h) {
    var k = new JSM.Body, l = a[0], m = b[0], n = (a[1] - a[0]) / c, p = (b[1] - b[0]) / d;
    (function() {
        var a, b, e, f;
        for (a = 0; a <= d; a++)
            for (b = 0; b <= c; b++)
                e = l + b * n, f = m + a * p, e = g(a, b, e, f, h), k.AddVertex(new JSM.BodyVertex(e))
    })();
    (function() {
        var a, b, g, h, l, m;
        for (b = 0; b < d; b++)
            for (a = 0; a < c; a++)
                g = b * (c + 1) + a, h = g + 1, l = g + c + 1, m = l + 1, e ? (h = new JSM.BodyPolygon([g, h, m]), f && h.SetCurveGroup(0), k.AddPolygon(h), h = new JSM.BodyPolygon([g, m, l])) : h = new JSM.BodyPolygon([g, h, m, l]), f && h.SetCurveGroup(0), k.AddPolygon(h)
    })();
    return k
};
...
JSM.SurfaceControlPoints.prototype.InitPlanar = function(a, b) {
    ...
    for (e = 0; e <= this.n; e++)
        for (f = 0; f <= this.m; f++)
            g = this.points[e][f], g.x = e * c, g.y = f * d
};
JSM.GenerateBezierSurface = function(a, b, c, d) {
    return JSM.GenerateSurface([0, 1], [0, 1], b, c, !1, d, function(a, b, c, d, k) {
        var l, m, n, p = k.GetNValue(), q = k.GetMValue();
        l = new JSM.Coord(0, 0, 0);
        for (a = 0; a <= p; a++) {
            m = new JSM.Coord(0, 0, 0);
            for (b = 0; b <= q; b++)
                n = JSM.BernsteinPolynomial(a, p, c) * JSM.BernsteinPolynomial(b, q, d), n = JSM.VectorMultiply(k.GetControlPoint(a, b), n), m = JSM.CoordAdd(m, n);
            l = JSM.CoordAdd(l, m)
        }
        return l
    }, a)
};
JSM.RenderMaterial = function(a, b, c, d, e, f, g) {
    this.ambient = a;
    this.diffuse = b;
    this.specular = c;
    this.shininess = d;
    this.texture = e;
    this.textureWidth = f;
    this.textureHeight = g;
    this.textureImage = this.textureBuffer = null;
    this.textureLoaded=!1
};
JSM.RenderMaterial.prototype.HasTexture = function() {
    return null !== this.texture && this.textureLoaded
};
JSM.RenderMaterial.prototype.Compile = function(a, b) {
    if (null !== this.texture) {
        var c = this;
        this.textureBuffer = a.createTexture();
        this.textureImage = new Image;
        this.textureImage.src = this.texture;
        this.textureImage.onload = function() {
            a.bindTexture(a.TEXTURE_2D, c.textureBuffer);
            a.texImage2D(a.TEXTURE_2D, 0, a.RGBA, a.RGBA, a.UNSIGNED_BYTE, c.textureImage);
...
JSM.RenderGeometry = function() {
    ...
    this.uvBuffer = this.normalBuffer = this.vertexBuffer = this.uvArray = this.normalArray = this.vertexArray = this.material = null
};
JSM.RenderGeometry.prototype.SetMaterial = function(a) {
    this.material = a
};
JSM.RenderGeometry.prototype.GetMaterial = function() {
    return this.material
};
JSM.RenderGeometry.prototype.SetVertexArray = function(a) {
    this.vertexArray = new Float32Array(a)
};
JSM.RenderGeometry.prototype.SetNormalArray = function(a) {
    this.normalArray = new Float32Array(a)
};
JSM.RenderGeometry.prototype.SetUVArray = function(a) {
...
JSM.RenderGeometry.prototype.SetTransformation = function(a) {
...
JSM.RenderGeometry.prototype.GetVertex = function(a) {
    return new JSM.Coord(this.vertexArray[3 * a], this.vertexArray[3 * a + 1], this.vertexArray[3 * a + 2])
};
JSM.RenderGeometry.prototype.GetTransformedVertex = function(a) {
    a = this.GetVertex(a);
    return this.transformation.Apply(a)
};
JSM.RenderGeometry.prototype.Compile = function(a, b) {
    this.material.Compile(a, b);
    ...
    this.normalBuffer = a.createBuffer();
    a.bindBuffer(a.ARRAY_BUFFER, this.normalBuffer);
    a.bufferData(a.ARRAY_BUFFER, this.normalArray, a.STATIC_DRAW);
    this.normalBuffer.itemSize = 3;
    this.normalBuffer.numItems =
    parseInt(this.normalArray.length / 3, 10);
    null !== this.uvArray && (this.uvBuffer = a.createBuffer(), a.bindBuffer(a.ARRAY_BUFFER, this.uvBuffer), a.bufferData(a.ARRAY_BUFFER, this.uvArray, a.STATIC_DRAW), this.uvBuffer.itemSize = 2, this.uvBuffer.numItems = parseInt(this.uvArray.length / 2, 10))
};
JSM.Renderer = function() {
    this.geometries = this.light = this.camera = this.texShader = this.shader = this.context = this.canvas = null
};
JSM.Renderer.prototype.Init = function(a, b, c) {
    return !JSM.IsWebGLEnabled() ||!this.InitContext(a) ||!this.InitView(b, c) ||!this.InitShaders() ||!this.InitBuffers()?!1 : !0
};
...
JSM.Renderer.prototype.InitShaders = function() {
    ...
    function b(b, c, d) {
        c = a(b, c, b.FRAGMENT_SHADER);
        d = a(b, d, b.VERTEX_SHADER);
        if (null === c || null === d)
            return null;
    ...
    function e(a, b) {
        ...
        b.lightAmbientColorUniform = a.getUniformLocation(b, "uLightAmbientColor");
        b.lightDiffuseColorUniform = a.getUniformLocation(b, "uLightDiffuseColor");
        b.lightSpecularColorUniform = a.getUniformLocation(b, "uLightSpecularColor");
        b.lightDirectionUniform = a.getUniformLocation(b, "uLightDirection");
        b.vMatrixUniform = a.getUniformLocation(b, "uViewMatrix");
        b.mvMatrixUniform =
        a.getUniformLocation(b, "uModelViewMatrix");
        b.pMatrixUniform = a.getUniformLocation(b, "uProjectionMatrix");
        b.polygonAmbientColorUniform = a.getUniformLocation(b, "uPolygonAmbientColor");
        b.polygonDiffuseColorUniform = a.getUniformLocation(b, "uPolygonDiffuseColor");
        b.polygonSpecularColorUniform = a.getUniformLocation(b, "uPolygonSpecularColor");
        b.polygonShininessUniform = a.getUniformLocation(b, "uPolygonShininess")
    }
    this.shader = function(a) {
        var g = c(!1), h = d(!1), g = b(a, g, h);
        if (null === g)
            return null;
        a.useProgram(g);
        e(a,
    ...
    if (null === this.shader)
        return !1;
    this.texShader = function(a) {
        var g = c(!0), h = d(!0), g = b(a, g, h);
        if (null === g)
            return null;
        a.useProgram(g);
        e(a, g);
        g.vertexUVAttribute = a.getAttribLocation(g, "aVertexUV");
        g.samplerUniform = a.getUniformLocation(g, "uSampler");
        return g
    }(this.context);
    return null === this.texShader?!1 : !0
};
JSM.Renderer.prototype.InitBuffers = function() {
    this.geometries = [];
    return !0
};
JSM.Renderer.prototype.InitView = function(a, b) {
    this.camera = JSM.ValueOrDefault(a, new JSM.Camera);
    if (!this.camera)
        return !1;
    this.light = JSM.ValueOrDefault(b, new JSM.Light);
    return !this.light?!1 : !0
};
JSM.Renderer.prototype.SetClearColor = function(a, b, c) {
    this.context.clearColor(a, b, c, 1)
};
JSM.Renderer.prototype.AddGeometries = function(a) {
    var b, c;
    for (b = 0; b < a.length; b++)
        c = a[b], c.Compile(this.context, this.Render.bind(this)), this.geometries.push(c)
};
...
JSM.PointCloudRenderer.prototype.AddPoints = function(a, b) {
    var c = this.context.createBuffer(), d = new Float32Array(a);
    ...
    var e = this.context.createBuffer(), f = new Float32Array(b);
...
JSM.PointCloudRenderer.prototype.Render = function() {
    this.context.viewport(0, 0, this.context.viewportWidth, this.context.viewportHeight);
    this.context.clear(this.context.COLOR_BUFFER_BIT | this.context.DEPTH_BUFFER_BIT);
    var a = JSM.MatrixPerspective(this.camera.fieldOfView * JSM.DegRad, this.context.viewportWidth / this.context.viewportHeight, this.camera.nearClippingPlane, this.camera.farClippingPlane);
    this.context.uniformMatrix4fv(this.shader.pMatrixUniform, !1, a);
    a = JSM.MatrixView(this.camera.eye, this.camera.center,
    this.camera.up);
...
JSM.ConvertBodyToRenderGeometries = function(a, b) {
    var c = [], d = null, e = null, f = null, g = null;
    JSM.ExplodeBodyToTriangles(a, b, {
        hasConvexPolygons: !1,
        onGeometryStart: function(a) {
            e = [];
            f = [];
            g = [];
            var b = JSM.HexColorToNormalizedRGBComponents(a.ambient), l = JSM.HexColorToNormalizedRGBComponents(a.diffuse), m = JSM.HexColorToNormalizedRGBComponents(a.specular);
            a = new JSM.RenderMaterial(b, l, m, a.shininess, a.texture, a.textureWidth, a.textureHeight);
            d = new JSM.RenderGeometry;
            d.SetMaterial(a);
            c.push(d)
        },
        onGeometryEnd: function(a) {
            d.SetVertexArray(e);
            d.SetNormalArray(f);
            null !== a.texture && d.SetUVArray(g)
        },
        onTriangle: function(a, b, c, d, n, p, q, t, r) {
            e.push(a.x, a.y, a.z);
            e.push(b.x, b.y, b.z);
            e.push(c.x, c.y, c.z);
            f.push(d.x, d.y, d.z);
            f.push(n.x, n.y, n.z);
            f.push(p.x, p.y, p.z);
            null !== q && (null !== t && null !== r) && (g.push(q.x, q.y), g.push(t.x, t.y), g.push(r.x, r.y))
        }
    });
    return c
};
JSM.ConvertModelToRenderGeometries = function(a, b) {
    var c = [], d, e;
    for (d = 0; d < a.BodyCount(); d++) {
        e = a.GetBody(d);
        var f = JSM.ConvertBodyToRenderGeometries(e, b, c);
        for (e = 0; e < f.length; e++)
            c.push(f[e])
    }
    return c
};
JSM.JSONFileLoader = function(a) {
    this.onReady = a
};
JSM.JSONFileLoader.prototype.Load = function(a) {
    var b = this, c = new XMLHttpRequest;
    c.overrideMimeType("application/json");
    c.open("GET", a, !0);
    c.onreadystatechange = function() {
        4 == c.readyState && b.OnReady(c.responseText)
    };
    c.send(null)
};
JSM.JSONFileLoader.prototype.OnReady = function(a) {
    null !== this.onReady && (a = JSON.parse(a), this.onReady(a))
};
JSM.Mouse = function() {
    this.down=!1;
    this.button = 0;
    this.alt = this.ctrl = this.shift=!1;
    this.diffY = this.diffX = this.currY = this.currX = this.prevY = this.prevX = 0
};
...
JSM.Mouse.prototype.SetCurrent = function(a, b) {
    this.currX = a.clientX;
    this.currY = a.clientY;
    void 0 !== b && (void 0 !== b.offsetLeft && void 0 !== b.offsetTop) && (this.currX -= b.offsetLeft, this.currY -= b.offsetTop)
};
JSM.Touch = function() {
    this.down=!1;
    this.diffY = this.diffX = this.currY = this.currX = this.prevY = this.prevX = 0
...
JSM.Touch.prototype.Move = function(a, b) {
    0 !== a.touches.length && (this.SetCurrent(a.touches[0], b), this.diffX = this.currX - this.prevX, this.diffY = this.currY - this.prevY, this.prevX = this.currX, this.prevY = this.currY)
};
...
JSM.Touch.prototype.SetCurrent = function(a, b) {
    this.currX = a.pageX;
    this.currY = a.pageY;
    void 0 !== b && (void 0 !== b.offsetLeft && void 0 !== b.offsetTop) && (this.currX = a.pageX - b.offsetLeft, this.currY = a.pageY - b.offsetTop)
};
JSM.Navigation = function() {
    this.orbitCenter = this.cameraEnableZoom = this.cameraEnablePan = this.cameraEnableOrbit = this.cameraFixUp = this.touch = this.mouse = this.resizeCallback = this.drawCallback = this.camera = this.canvas = null
};
...
JSM.Navigation.prototype.FitInWindow = function(a, b) {
    ...
    var c = JSM.VectorNormalize(JSM.CoordSub(this.camera.eye, this.camera.center)), d = this.camera.fieldOfView / 2;
    this.canvas.width < this.canvas.height && (d = d * this.canvas.width / this.canvas.height);
    d = b / Math.sin(d * JSM.DegRad);
    this.camera.eye = JSM.CoordOffset(this.camera.center, c, d);
    this.orbitCenter = this.camera.center.Clone()
};
JSM.Navigation.prototype.Orbit = function(a, b) {
    var c = a * JSM.DegRad, d = b * JSM.DegRad, e = JSM.VectorNormalize(JSM.CoordSub(this.camera.center, this.camera.eye)), f = JSM.VectorNormalize(JSM.VectorCross(e, this.camera.up)), g=!JSM.CoordIsEqual(this.orbitCenter, this.camera.center);
    this.cameraFixUp ? (e = JSM.GetVectorsAngle(e, this.camera.up) + d, JSM.IsGreater(e, 0) && JSM.IsLower(e, Math.PI) && (this.camera.eye = JSM.CoordRotate(this.camera.eye, f, - d, this.orbitCenter), g && (this.camera.center = JSM.CoordRotate(this.camera.center, f,
    ...
    e, - c, this.orbitCenter)), this.camera.up = e)
};
JSM.Navigation.prototype.Pan = function(a, b) {
    var c = JSM.VectorNormalize(JSM.CoordSub(this.camera.center, this.camera.eye)), d = JSM.VectorNormalize(JSM.VectorCross(c, this.camera.up)), c = JSM.VectorNormalize(JSM.VectorCross(d, c));
    this.camera.eye = JSM.CoordOffset(this.camera.eye, d, - a);
    this.camera.center = JSM.CoordOffset(this.camera.center, d, - a);
    this.camera.eye = JSM.CoordOffset(this.camera.eye, c, b);
    this.camera.center = JSM.CoordOffset(this.camera.center, c, b)
};
JSM.Navigation.prototype.Zoom = function(a) {
    var b = JSM.CoordSub(this.camera.center, this.camera.eye), c = JSM.VectorLength(b);
    if (a && 0.1 > c)
        return 0;
    c*=0.1;
    a || (c*=-1);
    this.camera.eye = JSM.CoordOffset(this.camera.eye, b, c)
};
...
JSM.Navigation.prototype.ResizeCallback = function() {
    void 0 !== this.resizeCallback && null !== this.resizeCallback && this.resizeCallback()
};
...
JSM.Navigation.prototype.OnMouseMove = function(a) {
    ...
    this.mouse.down && (a = 0, 1 == this.mouse.button ? this.cameraEnableOrbit && (a = 0.5, this.Orbit(this.mouse.diffX * a, this.mouse.diffY * a), this.DrawCallback()) : 3 == this.mouse.button && this.cameraEnablePan && (a = 0.001 * JSM.CoordDistance(this.camera.eye, this.camera.center), this.Pan(this.mouse.diffX * a, this.mouse.diffY * a), this.DrawCallback()))
};
...
JSM.Navigation.prototype.OnMouseWheel = function(a) {
    ...
    if (this.cameraEnableZoom) {
        ...
        var b = 0;
        a.detail ? b =- a.detail : a.wheelDelta && (b = a.wheelDelta / 40);
        this.Zoom(0 < b);
        this.DrawCallback()
    }
};
...
JSM.Navigation.prototype.OnTouchMove = function(a) {
    ...
    this.touch.down && this.cameraEnableOrbit && (this.Orbit(0.5 * this.touch.diffX, 0.5 * this.touch.diffY), this.DrawCallback())
};
...
JSM.SoftwareViewer.prototype.FitInWindow = function() {
    var a = this.GetCenter(), b = this.GetBoundingSphereRadius(a);
    this.navigation.FitInWindow(a, b);
    this.Draw()
};
...
JSM.SoftwareViewer.prototype.GetBoundingBox = function() {
    ...
    for (c = 0; c < this.bodies.length; c++) {
        ...
        for (d = 0; d < e.VertexCount(); d++)
            f = e.GetVertex(d), a.x = JSM.Minimum(a.x, f.position.x), a.y = JSM.Minimum(a.y, f.position.y), a.z = JSM.Minimum(a.z, f.position.z), b.x = JSM.Maximum(b.x, f.position.x), b.y = JSM.Maximum(b.y, f.position.y), b.z = JSM.Maximum(b.z, f.position.z)
    }
    return new JSM.Box(a, b)
};
JSM.SoftwareViewer.prototype.GetBoundingSphereRadius = function(a) {
    if (void 0 === a || null === a)
        a = this.GetCenter();
    var b = 0, c, d, e, f;
    for (c = 0; c < this.bodies.length; c++) {
        e = this.bodies[c][0];
        for (d = 0; d < e.VertexCount(); d++)
            f = e.GetVertex(d), f = JSM.CoordDistance(a, f.position), JSM.IsGreater(f, b) && (b = f)
    }
    return b
};
...
JSM.SoftwareViewer.prototype.Draw = function() {
    ...
    this.drawer.Clear();
    for (a = 0; a < this.bodies.length; a++)
        b = this.bodies[a], JSM.DrawProjectedBody(b[0], b[1], this.camera, this.drawMode, !1, this.drawer);
    return !0
};
...
JSM.SpriteViewer.prototype.NearestPointUnderPosition = function(a, b, c) {
    ...
    for (e = 0; e < this.projected.length; e++)
        f = this.projected[e], g = JSM.CoordDistance2D(new JSM.Coord2D(f.position.x, f.position.y), b), JSM.IsLower(g, a) && JSM.IsLower(g, d) && (c = f.originalIndex, d = g);
    return c
};
JSM.SpriteViewer.prototype.NearestPointUnderMouse = function(a) {
    return this.NearestPointUnderPosition(a, this.navigation.mouse.currX, this.navigation.mouse.currY)
};
JSM.SpriteViewer.prototype.NearestPointUnderTouch = function(a) {
    return this.NearestPointUnderPosition(a, this.navigation.touch.currX, this.navigation.touch.currY)
};
...
JSM.SpriteViewer.prototype.GetBoundingBox = function() {
    ...
    for (c = 0; c < this.points.length; c++)
        d = this.points[c], a.x = JSM.Minimum(a.x, d.x), a.y = JSM.Minimum(a.y, d.y), a.z = JSM.Minimum(a.z, d.z), b.x = JSM.Maximum(b.x, d.x), b.y = JSM.Maximum(b.y, d.y), b.z = JSM.Maximum(b.z, d.z);
    return new JSM.Box(a, b)
};
JSM.SpriteViewer.prototype.GetBoundingSphereRadius = function(a) {
    if (void 0 === a || null === a)
        a = this.GetCenter();
    var b = 0, c, d;
    for (c = 0; c < this.points.length; c++)
        d = this.points[c], d = JSM.CoordDistance(a, d), JSM.IsGreater(d, b) && (b = d);
    return b
};
JSM.SpriteViewer.prototype.Draw = function() {
    if (null !== this.callbacks.onDrawStart)
        this.callbacks.onDrawStart(this.canvas);
    var a = this.canvas.width / this.canvas.height, b = [0, 0, this.canvas.width, this.canvas.height];
    this.projected = [];
    var c, d;
    for (c = 0; c < this.points.length; c++)
        d = this.points[c], d = JSM.Project(d, this.camera.eye, this.camera.center, this.camera.up, this.camera.fieldOfView * JSM.DegRad, a, this.camera.nearClippingPlane, this.camera.farClippingPlane, b), d.y = this.canvas.height - d.y, null !== d && this.projected.push({
            position: d,
            originalIndex: c
        });
...
JSM.Viewer = function() {
    this.navigation = this.renderer = null
};
JSM.Viewer.prototype.Init = function(a, b, c) {
    return !this.InitRenderer(a, b, c) ||!this.InitNavigation()?!1 : !0
};
JSM.Viewer.prototype.InitRenderer = function(a, b, c) {
    this.renderer = new JSM.Renderer;
    return !this.renderer.Init(a, b, c)?!1 : !0
};
...
JSM.Viewer.prototype.AddGeometries = function(a) {
    this.renderer.AddGeometries(a);
    this.Draw()
};
...
JSM.Viewer.prototype.GetBoundingBox = function() {
    var a = new JSM.Coord(JSM.Inf, JSM.Inf, JSM.Inf), b = new JSM.Coord( - JSM.Inf, - JSM.Inf, - JSM.Inf), c, d, e, f;
    for (c = 0; c < this.renderer.geometries.length; c++) {
        e = this.renderer.geometries[c];
        for (d = 0; d < e.VertexCount(); d += 1)
            f = e.GetTransformedVertex(d), a.x = JSM.Minimum(a.x, f.x), a.y = JSM.Minimum(a.y, f.y), a.z = JSM.Minimum(a.z, f.z), b.x = JSM.Maximum(b.x, f.x), b.y = JSM.Maximum(b.y, f.y), b.z = JSM.Maximum(b.z, f.z)
    }
    return new JSM.Box(a, b)
};
JSM.Viewer.prototype.GetBoundingSphereRadius = function(a) {
    if (void 0 === a || null === a)
        a = this.GetCenter();
    var b = 0, c, d, e, f;
    for (c = 0; c < this.renderer.geometries.length; c++) {
        e = this.renderer.geometries[c];
        for (d = 0; d < e.VertexCount(); d += 1)
            f = e.GetTransformedVertex(d), f = JSM.CoordDistance(a, f), JSM.IsGreater(f, b) && (b = f)
    }
    return b
};
...
JSM.PointCloudViewer.prototype.GetBoundingBox = function() {
    ...
    for (c = 0; c < this.renderer.points.length; c++) {
        ...
        for (d = 0; d < e.length; d += 3)
            f = new JSM.Coord(e[d], e[d + 1], e[d + 2]), a.x = JSM.Minimum(a.x, f.x), a.y = JSM.Minimum(a.y, f.y), a.z = JSM.Minimum(a.z, f.z), b.x = JSM.Maximum(b.x, f.x), b.y = JSM.Maximum(b.y, f.y), b.z = JSM.Maximum(b.z, f.z)
    }
    return new JSM.Box(a, b)
};
JSM.PointCloudViewer.prototype.GetBoundingSphereRadius = function(a) {
    if (void 0 === a || null === a)
        a = this.GetCenter();
    var b = 0, c, d, e, f;
    for (c = 0; c < this.renderer.points.length; c++) {
        e = this.renderer.points[c].pointArray;
        for (d = 0; d < e.length; d += 3)
            f = new JSM.Coord(e[d], e[d + 1], e[d + 2]), f = JSM.CoordDistance(a, f), JSM.IsGreater(f, b) && (b = f)
    }
    return b
};
...
JSM.ResizeImageToPowerOfTwoSides = function(a) {
    if (JSM.IsPowerOfTwo(a.width)&&!JSM.IsPowerOfTwo(a.height))
        return a;
    var b = JSM.NextPowerOfTwo(a.width), c = JSM.NextPowerOfTwo(a.height), d = document.createElement("canvas");
    d.width = b;
    d.height = c;
    d = d.getContext("2d");
...
JSM.ConvertBodyToThreeMeshes = function(a, b, c) {
    var d = {
        textureLoadedCallback: null,
        hasConvexPolygons: !1,
        doubleSided: !0
    };
    void 0 !== c && null !== c && (d.textureLoadedCallback = JSM.ValueOrDefault(c.textureLoadedCallback, d.textureLoadedCallback), d.hasConvexPolygons = JSM.ValueOrDefault(c.hasConvexPolygons, d.hasConvexPolygons), d.doubleSided = JSM.ValueOrDefault(c.doubleSided, d.doubleSided));
    var e = [], f = null;
    JSM.ExplodeBodyToTriangles(a, b, {
        ...
        onGeometryEnd: function(a) {
            var b = null !== a.texture, c = 1 !== a.opacity, l = new THREE.MeshPhongMaterial({
                ambient: a.ambient,
                color: a.diffuse,
                specular: a.specular,
                shininess: a.shininess
            });
            d.doubleSided && (l.side = THREE.DoubleSide);
            c && (l.opacity = a.opacity, l.transparent=!0);
            if (b) {
                var m = THREE.ImageUtils.loadTexture(a.texture, new THREE.UVMapping, function() {
                    m.image = JSM.ResizeImageToPowerOfTwoSides(m.image);
            ...
            a = new THREE.Mesh(f, l);
            e.push(a)
        },
        onTriangle: function(a, b, c, d, e, n, p, q, t) {
            var r = f.vertices.length;
            f.vertices.push(new THREE.Vector3(a.x, a.y, a.z));
            f.vertices.push(new THREE.Vector3(b.x, b.y, b.z));
            f.vertices.push(new THREE.Vector3(c.x, c.y, c.z));
            a = new THREE.Face3(r + 0, r + 1, r + 2);
            f.faces.push(a);
            null !== d && (null !== e && null !== n) && (a = [], a.push(new THREE.Vector3(d.x, d.y, d.z)), a.push(new THREE.Vector3(e.x, e.y, e.z)), a.push(new THREE.Vector3(n.x, n.y, n.z)), f.faces[f.faces.length - 1].vertexNormals =
            a);
            null !== p && (null !== q && null !== t) && (d = [], d.push(new THREE.Vector2(p.x, - p.y)), d.push(new THREE.Vector2(q.x, - q.y)), d.push(new THREE.Vector2(t.x, - t.y)), f.faceVertexUvs[0].push(d))
        }
    });
    return e
};
JSM.ConvertModelToThreeMeshes = function(a, b, c) {
    var d = [], e = [], f, g;
    for (f = 0; f < a.BodyCount(); f++) {
        e = a.GetBody(f);
        e = JSM.ConvertBodyToThreeMeshes(e, b, c);
        for (g = 0; g < e.length; g++)
            d.push(e[g])
    }
    return d
};
JSM.ConvertJSONDataToThreeMeshes = function(a, b, c) {
    function d(a, c) {
        function d(a) {
            function k(a, b, c, d, e) {
                c = new THREE.Vector2(a, b);
                JSM.IsZero(e) || (d = Math.sin(e * JSM.DegRad), e = Math.cos(e * JSM.DegRad), c.x = e * a - d * b, c.y = d * a + e * b);
                c.x = t[0] + c.x * y[0];
                c.y = t[1] + c.y * y[1];
                return c
            }
            var m = a.parameters, r = f[a.material];
            a = r.texture;
            var t = r.offset, y = r.scale, w = r.rotation, A = new THREE.Color, B = new THREE.Color, L = new THREE.Color, N = r.shininess;
            A.setRGB(r.ambient[0], r.ambient[1], r.ambient[2]);
            B.setRGB(r.diffuse[0], r.diffuse[1], r.diffuse[2]);
            L.setRGB(r.specular[0], r.specular[1], r.specular[2]);
            if (void 0 !== a && null !== a) {
                A.setRGB(1, 1, 1);
                B.setRGB(1, 1, 1);
                L.setRGB(1, 1, 1);
            ...
            1 !== r.opacity && (A.opacity = r.opacity, A.transparent=!0);
            void 0 !== a && null !== a && (r = THREE.ImageUtils.loadTexture(a, new THREE.UVMapping, function(a) {
                a.image = JSM.ResizeImageToPowerOfTwoSides(a.image);
                void 0 !== b && null !== b && b()
            }), r.wrapS = THREE.RepeatWrapping, r.wrapT = THREE.RepeatWrapping, A.map = r);
            var r = new THREE.Geometry, F, C, D, J, O, M, H, G, I;
            for (I = 0; I < m.length; I += 9)
                F = 3 * m[I + 0], C = 3 * m[I + 1], D = 3 * m[I + 2], J = 3 * m[I + 3], O = 3 * m[I + 4], M = 3 * m[I + 5], B = 2 * m[I + 6], L = 2 * m[I + 7], N = 2 * m[I + 8], H = r.vertices.length, G = r.faces.length, r.vertices.push(new THREE.Vector3(g[F + 0], g[F + 1], g[F + 2])), r.vertices.push(new THREE.Vector3(g[C + 0], g[C + 1], g[C + 2])), r.vertices.push(new THREE.Vector3(g[D + 0], g[D + 1], g[D + 2])), r.faces.push(new THREE.Face3(H + 0,
                H + 1, H + 2)), F = [], F.push(new THREE.Vector3(h[J + 0], h[J + 1], h[J + 2])), F.push(new THREE.Vector3(h[O + 0], h[O + 1], h[O + 2])), F.push(new THREE.Vector3(h[M + 0], h[M + 1], h[M + 2])), r.faces[G].vertexNormals = F, void 0 !== a && null !== a && (J = [], J.push(k(q[B + 0], q[B + 1], t, y, w)), J.push(k(q[L + 0], q[L + 1], t, y, w)), J.push(k(q[N + 0], q[N + 1], t, y, w)), r.faceVertexUvs[0].push(J));
            m = new THREE.Mesh(r, A);
            m.originalJsonIndex = c;
            e.push(m)
        }
        var g = a.vertices;
        if (void 0 !== g) {
...
JSM.JSONFileConverter = function(a, b) {
    this.onReady = a;
    this.onTextureLoaded = b
};
JSM.JSONFileConverter.prototype.Convert = function(a) {
    (new JSM.JSONFileLoader(this.OnReady.bind(this))).Load(a)
};
JSM.JSONFileConverter.prototype.OnReady = function(a) {
    null !== this.onReady && (a = JSM.ConvertJSONDataToThreeMeshes(a, this.onTextureLoaded), this.onReady(a))
};
...
JSM.ThreeViewer.prototype.Start = function(a, b) {
    if (!JSM.IsWebGLEnabled() ||!this.InitSettings(b) ||!this.InitThree(a) ||!this.InitCamera(b) ||!this.InitLights())
        return !1;
    this.drawLoop=!1;
    this.enableDraw=!0;
    this.DrawIfNeeded();
...
JSM.ThreeViewer.prototype.InitLights = function() {
    var a = new THREE.Color, b = new THREE.Color;
...
JSM.ThreeViewer.prototype.VertexCount = function() {
    var a = 0;
    this.scene.traverse(function(b) {
        b instanceof THREE.Mesh && (a += b.geometry.vertices.length)
    });
    return a
};
...
JSM.ThreeViewer.prototype.GetMesh = function(a) {
    ...
    for (d = 0; d < this.scene.children.length; d++)
        if (b = this.scene.children[d], b instanceof THREE.Mesh) {
            if (c == a)
                return b;
                c += 1
        }
...
JSM.ThreeViewer.prototype.RemoveMeshes = function() {
    var a, b;
    for (b = 0; b < this.scene.children.length; b++)
        a = this.scene.children[b], a instanceof THREE.Mesh && (this.scene.remove(a), b--);
    this.DrawIfNeeded()
};
JSM.ThreeViewer.prototype.RemoveLastMesh = function() {
    var a = null;
    this.scene.traverse(function(b) {
        b instanceof THREE.Mesh && (a = b)
    });
    null !== a && this.scene.remove(a);
    this.DrawIfNeeded()
};
JSM.ThreeViewer.prototype.SetCamera = function(a, b, c) {
    this.navigation.SetCamera(a, b, c);
...
JSM.ThreeViewer.prototype.AdjustClippingPlanes = function(a) {
    ...
    this.GetBoundingSphereRadius(b) < a ? (this.camera.near = 0.1, this.camera.far = 1E3) : (this.camera.near = 10, this.camera.far = 1E6);
    this.camera.updateProjectionMatrix();
    this.Draw()
};
...
JSM.ThreeViewer.prototype.GetBoundingBox = function() {
    ...
    this.scene.traverse(function(e) {
        if (e instanceof THREE.Mesh) {
            c = e.geometry;
            var f;
            for (f = 0; f < c.vertices.length; f++)
                d = c.vertices[f].clone(), d.add(e.position), a.x = JSM.Minimum(a.x, d.x), a.y = JSM.Minimum(a.y, d.y), a.z = JSM.Minimum(a.z, d.z), b.x = JSM.Maximum(b.x, d.x), b.y = JSM.Maximum(b.y, d.y), b.z = JSM.Maximum(b.z, d.z)
        }
    });
    return new JSM.Box(a, b)
};
JSM.ThreeViewer.prototype.GetBoundingSphereRadius = function(a) {
    if (void 0 === a || null === a)
        a = this.GetCenter();
    var b = 0, c, d, e;
    this.scene.traverse(function(f) {
        if (f instanceof THREE.Mesh) {
            ...
            for (g = 0; g < c.vertices.length; g++)
                d = c.vertices[g].clone(), d.add(f.position), e = JSM.CoordDistance(a, new JSM.Coord(d.x, d.y, d.z)), JSM.IsGreater(e, b) && (b = e)
        }
    });
    return b
};
JSM.ThreeViewer.prototype.GetObjectsUnderPosition = function(a, b) {
    var c = 2 * (a / this.canvas.width) - 1, d = 2*-(b / this.canvas.height) + 1, e = new THREE.Projector, f = this.camera.position, c = new THREE.Vector3(c, d, 0.5);
    e.unprojectVector(c, this.camera);
    c.sub(f);
    c.normalize();
    return (new THREE.Raycaster(f, c)).intersectObjects(this.scene.children)
};
...
JSM.ThreeViewer.prototype.ProjectVector = function(a, b, c) {
    var d = this.canvas.width / 2, e = this.canvas.height / 2, f = new THREE.Projector;
    a = new THREE.Vector3(a, b, c);
    f.projectVector(a, this.camera);
    a.x = a.x * d + d;
    a.y =- (a.y * e) + e;
    return a
};
